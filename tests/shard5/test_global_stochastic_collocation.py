...
def test_obstacle_avoidance_direct_collocation(use_sx: bool):
    ...
    np.testing.assert_almost_equal(
        m[:, 0],
        np.array([ 1.00000000e+00, -5.05457090e-25, -3.45225516e-23,  4.63567667e-24,
       -2.07762174e-24,  1.00000000e+00,  5.85505404e-24,  2.11044910e-24,
        5.35541145e-25, -7.33375346e-25,  1.00000000e+00,  3.31004423e-24,
        6.69132819e-25, -1.55199996e-25,  1.61445742e-24,  1.00000000e+00,
        1.90797247e-01, -1.19090552e-02, -3.23045118e-01, -8.36867760e-02,
       -1.29812817e-02,  1.69927215e-01, -9.02323302e-02, -4.15440327e-01,
        2.91358598e-02,  4.62429927e-03, -4.04540496e-02,  2.59478026e-03,
        5.65168256e-03,  4.62998816e-02,  5.73943076e-03, -3.07383562e-02,
        3.91343262e-01, -6.89506402e-03, -4.87839314e-01, -8.10220212e-02,
       -7.02994760e-03,  3.85606978e-01, -8.33694095e-02, -5.61696657e-01,
        4.84320277e-02,  7.51042245e-03,  4.20836460e-02,  4.20298027e-02,
        7.79698790e-03,  5.92538743e-02,  4.52842640e-02,  9.08680212e-02,
        2.76261710e-01,  9.59731386e-05, -1.11028293e-01, -7.03012679e-03,
        6.11634134e-05,  2.76243341e-01, -6.74241321e-03, -1.14566661e-01,
        1.09070369e-02,  7.09878476e-04,  1.98625775e-01,  1.83359034e-02,
        7.31642248e-04,  1.11477554e-02,  1.81224176e-02,  2.12172685e-01]),
        decimal=6,
    )

    np.testing.assert_almost_equal(
        cov[:, -1],
        np.array([ 0.00266764, -0.0005587 ,  0.00241239, -0.00088205, -0.0005587 ,
        0.00134316, -0.00048081,  0.00673894,  0.00241239, -0.00048081,
       -0.00324733, -0.00175754, -0.00088205,  0.00673894, -0.00175754,
        0.02038775]),
        decimal=6,
    )
