...
def test_obstacle_avoidance_direct_collocation():
    ...
    # initial and final position
    np.testing.assert_almost_equal(q[:, 0], np.array([0.0,  2.91660270e+00]))
    np.testing.assert_almost_equal(q[:, -1], np.array([0.0, 2.91660270e+00]))
    ...
    np.testing.assert_almost_equal(
        ...
        np.array(
            [
                1.00000000e+00, -1.05389293e-23, -9.29903240e-24, 1.00382361e-23,
                -1.64466833e-23, 1.00000000e+00, 1.21492152e-24, -3.15104115e-23,
                -6.68416587e-25, -6.00029062e-24, 1.00000000e+00, 1.99489733e-23,
                -1.16322274e-24, -2.03253417e-24, -3.00499207e-24, 1.00000000e+00,
                2.19527862e-01, -1.88588087e-02, -2.00283989e-01, -8.03404360e-02,
                -1.99327784e-02, 2.02962627e-01, -8.39758964e-02, -2.49822789e-01,
                1.76793622e-02, 5.30096916e-03, -6.35628572e-03, -1.01527618e-02,
                6.21147642e-03, 2.87692596e-02, -1.06499714e-02, -1.48244735e-02,
                4.01184050e-01, -1.20760665e-02, -3.47575458e-01, -1.01031369e-01,
                -1.22801502e-02, 3.94781689e-01, -1.03912381e-01, -4.08950331e-01,
                3.31437788e-02, 9.65931210e-03, 1.64098610e-03, 3.61379227e-02,
                9.94099379e-03, 4.10555191e-02, 3.89631730e-02, 2.71848362e-02,
                2.74709609e-01, -6.03467730e-05, -1.00613832e-01, -1.27941917e-02,
                -9.52485792e-05, 2.74478998e-01, -1.23522568e-02, -1.07746467e-01,
                1.00776666e-02, 1.25778066e-03, 1.65876475e-01, 2.50629520e-02,
                1.28718848e-03, 1.07109173e-02, 2.48728130e-02, 1.81242999e-01,
            ]
        ),
        decimal=6,
    )
    ...
    np.testing.assert_almost_equal(
        ...
        np.array(
            [
                0.00440214, -0.00021687, 0.00470812, -0.00133034, -0.00021687,
                0.00214526, -0.00098746, 0.00142654, 0.00470812, -0.00098746,
                0.02155766, -0.00941652, -0.00133034, 0.00142654, -0.00941652,
                0.00335482,
            ]
        ),
        decimal=6,
