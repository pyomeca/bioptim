...
def test_obstacle_avoidance_direct_collocation(use_sx: bool):
    ...
    # initial and final position
    npt.assert_almost_equal(q[:, 0], np.array([9.33415918e-22, 2.98741686e+00]))
    npt.assert_almost_equal(q[:, -1], np.array([9.34900539e-22, 2.98741686e+00]))
    ...
    npt.assert_almost_equal(
        ...
        np.array(
            [
                1.00000000e+00, -4.49572966e-22, -2.29111163e-18, -5.69115647e-19,
                -1.37463144e-18, 1.00000000e+00, 2.71740231e-20, 1.88094678e-18,
                2.15236673e-17, 9.12657816e-22, 1.00000000e+00, 1.28596672e-18,
                2.59650412e-18, -1.98702849e-22, 1.16174719e-20, 1.00000000e+00,
                8.97683613e-02, -9.16539400e-03, -1.93148619e-01, -4.27328970e-02,
                -9.47788674e-03, 7.40548692e-02, -4.32328089e-02, -2.40016559e-01,
                2.23761124e-02, 2.18125527e-03, -1.21607303e-02, -2.13744866e-03,
                2.48984982e-03, 2.80212107e-02, -1.78112311e-03, -1.51957449e-02,
                2.01865677e-01, -6.20640335e-03, -2.89187247e-01, -5.29601676e-02,
                -6.06943355e-03, 1.94137289e-01, -5.19802435e-02, -3.46986013e-01,
                3.21298014e-02, 3.85369918e-03, 4.01442349e-02, 1.71540495e-02,
                3.88746216e-03, 3.69482073e-02, 1.76978741e-02, 5.61188146e-02,
                1.49788124e-01, -3.05585700e-05, -6.99765523e-02, -6.16591796e-03,
                -1.50835457e-05, 1.49690852e-01, -5.61298940e-03, -7.60514239e-02,
                7.56174614e-03, 4.32208391e-04, 1.11030048e-01, 9.28078562e-03,
                4.01508193e-04, 7.98866164e-03, 8.79013240e-03, 1.19253753e-01
            ]
        ),
        decimal=6,
    )
    ...
    npt.assert_almost_equal(
        ...
        np.array(
            [
                0.00147778, -0.00102866, 0.00716552, -0.00024668, -0.00102866,
                0.00210025, -0.00015164, 0.00911479, 0.00716552, -0.00015164,
                -0.0070975, -0.01337138, -0.00024668, 0.00911479, -0.01337138,
                0.01419299
            ]
        ),
        decimal=6,
