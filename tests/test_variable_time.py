...
def prepare_ocp(phase_time_constraint, use_parameter, assume_phase_dynamics):
    ...
    dynamics.add(DynamicsFcn.TORQUE_DRIVEN, phase=0, expand=False)
    dynamics.add(DynamicsFcn.TORQUE_DRIVEN, phase=1, expand=False)
    dynamics.add(DynamicsFcn.TORQUE_DRIVEN, phase=2, expand=False)
