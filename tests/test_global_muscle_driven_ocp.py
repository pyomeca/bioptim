...
def test_muscle_driven_ocp(ode_solver):
    ...
    if ode_solver == OdeSolver.RK4:
        ...
        np.testing.assert_almost_equal(
            mus[:, 0],
            np.array([4.58410571e-06, 5.97816053e-01, 3.31990595e-01, 1.10272434e-05,
 1.16080375e-05, 3.60499511e-01]),
        )
        np.testing.assert_almost_equal(
            mus[:, -2],
            np.array([5.20539825e-05, 6.32041077e-03, 3.64566577e-03, 4.91166408e-04,
 5.07451759e-04, 8.87382356e-03]),
        )
        ...
        np.testing.assert_almost_equal(
            mus[:, 0],
            np.array([4.44790964e-06, 5.97816063e-01, 3.31990620e-01, 1.10272405e-05,
 1.16080346e-05, 3.60499532e-01]),
        )
        np.testing.assert_almost_equal(
            mus[:, -2],
            np.array([4.67158105e-05, 6.36064841e-03, 3.70441050e-03, 5.16633150e-04,
 5.33757415e-04, 8.89768052e-03]),
        )
        ...
        np.testing.assert_almost_equal(
            mus[:, 0],
            np.array([4.44786958e-06, 5.97813268e-01, 3.31987682e-01, 1.10273614e-05,
 1.16081619e-05, 3.60495697e-01]),
        )
        np.testing.assert_almost_equal(
            mus[:, -2],
            np.array([4.67154321e-05, 6.38489487e-03, 3.73719311e-03, 5.30535414e-04,
 5.48115098e-04, 8.91280115e-03]),
        )
    else:
