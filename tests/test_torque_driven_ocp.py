...
def test_track_marker_2D_pendulum():
    ...
    spec = importlib.util.spec_from_file_location(
        ...
        str(PROJECT_FOLDER) + "/examples/torque_driven_ocp/track_markers_2D_pendulum.py",
    )
    ...
    markers_ref[1, :, :] = np.array([[ 0.        ,  0.59994037,  1.41596094,  1.78078534,  2.00186844,
         2.21202252,  2.44592581,  2.66008025,  2.52186711,  1.70750629,
         1.01558254,  0.80411881,  0.93002487,  1.10917845,  0.99843605,
         0.67973254,  0.50780818,  0.28087458, -0.72163361, -0.76304319,
         0.        ],
       [ 0.1       ,  0.39821962,  0.84838182,  1.09895944,  1.30730217,
         1.56395927,  1.89764787,  2.28282596,  2.53658449,  2.38557865,
         2.00463841,  1.75824184,  1.65985162,  1.54219021,  1.25554824,
         0.87993452,  0.59982138,  0.30228811, -0.38347237, -0.48508912,
        -0.09840722]])

    markers_ref[2, 1, :]=np.array([-1.        , -0.98453478, -0.8293696 , -0.73831799, -0.72634543,
       -0.7681237 , -0.84225371, -0.931493  , -1.00487979, -0.74176672,
       -0.17823715,  0.31567267,  0.69090731,  0.90691831,  0.97154172,
        0.98484474,  1.00076649,  1.0047594 ,  0.94638627,  0.96578545,
        1.000158  ])

    tau_ref = np.zeros((2, nb_shooting))
    tau_ref[0, :] = np.array([ 26.50837752, -13.00256609,  -4.73822352,   0.98400741,
         3.31060529,   3.53663986,   1.04020674, -12.72188939,
       -23.25758642,   2.81968664,   9.13976837,   4.01638109,
        -5.72934928,  -9.29116278,   1.38256926,   7.10636934,
        -8.65483649, -25.85422034,  77.77873644, -34.37165499])
