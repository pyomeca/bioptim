...
def test_trampo_quaternions():
    ...
    # initial and final position
    np.testing.assert_almost_equal(q[:, 0], np.array([1.81733618,  1.91082782,  2.02193743, -0.84381268,  0.23064357,
       -0.1144903 ,  0.01311558, -0.21374029, -0.02347896, -0.02229743,
        0.26528254,  0.01523419,  0.17449245,  0.29814568]))
    np.testing.assert_almost_equal(q[:, -1], np.array([ 3.14159265,  3.14159265,  3.14159265, -0.78539815,  0.6154797 ,
        0.11328926,  0.04342903, -0.72484712,  0.09541628,  0.10949053,
        0.77370487,  0.03553073,  0.68088644,  0.62300095]))

    # initial and final velocities
    np.testing.assert_almost_equal(qdot[:, 0], np.array([5.283146  , 4.90484264, 5.68811728, 0.20942182, 1.52481683,
       0.96748662, 0.91316783, 0.94054827, 0.68759761, 0.61102294,
       1.29868603, 0.83559735]))
    np.testing.assert_almost_equal(qdot[:, -1], np.array([5.3169947 , 4.94374858, 3.27109699, 0.27346275, 1.54682304,
       0.84367607, 0.9206181 , 0.5073864 , 1.26417877, 1.25894871,
       1.37192403, 1.14417031]))

    # initial and final controls
    np.testing.assert_almost_equal(tau[:, 0], np.array([ 7.56043829e-12, -4.62357990e-12,  3.95552231e-12,  5.34055729e-12,
       -2.59038339e-12,  1.20850012e-10,  2.75541035e-10,  3.29498993e-10,
       -3.16341751e-08,  4.29817209e-11,  3.81371955e-10, -1.86468937e-08]))
    np.testing.assert_almost_equal(tau[:, -1], np.array([ 3.65581807e-12,  1.80049643e-12,  7.07643769e-14, -5.12073140e-12,
       -2.32400322e-11, -2.45080035e-10,  6.05871820e-10,  4.15833830e-10,
       -2.41615373e-08, -3.16721464e-10,  2.80451931e-10, -1.03280585e-08]))