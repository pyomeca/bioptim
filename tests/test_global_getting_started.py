...
def test_multistart():
    ...
    np.testing.assert_almost_equal(multi_start_0, np.array([[  0.        ,  -0.9       ,  -0.9       ,   2.28173011,
         -0.9       ,   0.        ],
       [  0.        ,  -3.33470877,   1.03582785,   0.5207875 ,
          6.18318531,   3.14      ],
       [  0.        ,  31.10176758,  17.61481121, -31.10176758,
         30.90317007,   0.        ],
       [  0.        ,  31.10176758, -31.10176758,  17.78161852,
        -31.10176758,   0.        ]]))

    np.testing.assert_almost_equal(multi_start_1, np.array([[  0.        ,   2.64389392,  -0.9       ,  -0.9       ,
         -0.9       ,   0.        ],
       [  0.        ,  -3.88148228,  -2.59451636,   0.97557093,
         -2.03086336,   3.14      ],
       [  0.        ,  31.10176758, -31.10176758,  21.42157911,
        -10.39178501,   0.        ],
       [  0.        , -31.10176758,  31.10176758,  31.10176758,
        -23.44580925,   0.        ]]))

    np.testing.assert_almost_equal(multi_start_2, np.array([[  0.        ,  -0.71532847,  -0.4608428 ,   2.27440424,
          3.57676431,   3.28462688,   3.30741665,   3.82384424,
          1.89930146,   0.07072928,   0.        ],
       [  0.        ,   0.70611391,   2.62954049,   3.46119607,
         -5.51933103,   5.63914557,  -5.92370028,  -6.28315813,
          4.74576967,  -5.31467736,   3.14      ],
       [  0.        ,  -6.79260824,  11.56374193,  29.09363983,
         13.34481313, -20.71621446,  13.42937666,   3.84672861,
        -16.47247135,   3.03804164,   0.        ],
       [  0.        ,   6.66367221,  -5.77455202,  10.55981643,
        -17.13464347,  19.20417327, -17.53439889,  -9.70172735,
         13.21367517,  -9.00561861,   0.        ]]))

    np.testing.assert_almost_equal(multi_start_3, np.array([[  0.        ,   2.64389392,  -0.9       ,  -0.9       ,
         -0.9       ,  -0.9       ,  -0.9       ,  -0.9       ,
         -0.9       ,   0.46580081,   0.        ],
       [  0.        ,  -6.18318531,   6.18318531,  -6.18318531,
          4.28431582,  -2.078357  ,   1.47503627,  -6.18318531,
         -6.18318531,   6.18318531,   3.14      ],
       [  0.        ,  24.16797266,  31.10176758,  31.10176758,
        -31.10176758, -31.10176758, -31.10176758,  31.10176758,
        -31.10176758,  -9.91390823,   0.        ],
       [  0.        ,  24.11198926, -23.18298953,  23.43639777,
         31.10176758, -31.10176758,  31.10176758,  31.10176758,
         31.10176758, -27.59022166,   0.        ]]))