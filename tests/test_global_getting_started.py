...
def test_multistart():
    ...
    with open("pendulum_multi_start_random_states_5_0.pkl", "rb") as file:
    ...
    with open("pendulum_multi_start_random_states_10_0.pkl", "rb") as file:
    ...
    np.testing.assert_almost_equal(multi_start_0, np.array([[  0.        ,  -0.9       ,  -0.9       ,   1.41466479,
         -0.9       ,   0.        ],
       [  0.        ,  -3.27837317,  -5.3654552 ,   1.06949054,
         -5.5005935 ,   3.14      ],
       [  0.        ,  14.84436583,  -7.25360623,   7.20431622,
         -5.46014257,   0.        ],
       [  0.        ,   4.10807195, -23.36876615, -15.03660248,
        -18.21460587,   0.        ]]))

    np.testing.assert_almost_equal(multi_start_1, np.array([[  0.        ,   1.32194696,  -0.9       ,  -0.9       ,
         -0.9       ,   0.        ],
       [  0.        ,  -1.94074114,  -1.29725818,   0.48778547,
         -1.01543168,   3.14      ],
       [  0.        ,  23.75781921, -29.6951133 ,  10.71078955,
         -5.19589251,   0.        ],
       [  0.        , -18.96884288,  18.89633855,  29.42174252,
        -11.72290462,   0.        ]]))

    np.testing.assert_almost_equal(multi_start_2, np.array([[  0.        ,  -0.9       ,  -0.9       ,   1.41466479,
         -0.9       ,   0.24450363,  -0.03217023,  -0.9       ,
         -0.9       ,   0.51064412,   0.        ],
       [  0.        ,   2.7874511 ,   2.96887317,  -1.45072125,
          1.44086324,  -1.09202851,   4.34559767,   4.05329642,
          0.82161439,  -4.67375323,   3.14      ],
       [  0.        ,   5.04239565, -14.07712741, -16.10925968,
         19.27000157,  -8.59459673, -17.93980114, -15.56710432,
         -5.02231155,  -3.85702892,   0.        ],
       [  0.        , -13.48787276,  -1.53161416,   1.63212886,
        -19.73693304, -14.35580265,  -1.25984363, -20.30540394,
         22.31971374, -27.89108383,   0.        ]]))

    np.testing.assert_almost_equal(multi_start_3, np.array([[  0.        ,   1.32194696,  -0.9       ,  -0.9       ,
         -0.9       ,  -0.9       ,  -0.9       ,  -0.92663564,
         -0.61939515,   0.2329004 ,   0.        ],
       [  0.        ,  -3.71396256,   4.75156384,  -5.93902266,
          2.14215791,  -1.0391785 ,   0.73751814,  -4.51903101,
         -3.79376858,   3.77926771,   3.14      ],
       [  0.        ,  12.08398633,  23.64922791,  24.7938679 ,
        -26.07244114, -28.96204213, -20.74516657,  23.75939422,
        -25.23661272,  -4.95695411,   0.        ],
       [  0.        ,  12.05599463, -11.59149477,  11.71819889,
         21.02515105, -30.26684018,  15.71703084,  30.71604811,
         15.59270793, -13.79511083,   0.        ]]))