...
def test_multistart():
    ...
    np.testing.assert_almost_equal(
        ...
        np.array(
            [
                [0.0, 1.2911362, 0.61658026, 0.2692991, -0.4580712, 0.0],
                [0.0, 4.92316472, 5.82655809, -1.46471707, 3.66592495, 3.14],
                [0.0, 26.74102545, -26.95259936, -25.94143118, -30.14556716, 0.0],
                [0.0, 23.24854893, 30.07247736, 18.79668695, -2.42032305, 0.0],
            ]
        ),
    )
