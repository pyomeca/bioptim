...
def test_multistart():
    ...
    np.testing.assert_almost_equal(
        ...
        np.array(
            [
                [0.0, 2.5822724, 1.23316051, 0.5385982, -0.91614241, 0.0],
                [0.0, 6.18318531, 6.18318531, -2.92943415, 6.18318531, 3.14],
                [0.0, 31.10176758, -31.10176758, -31.10176758, -31.10176758, 0.0],
                [0.0, 31.10176758, 31.10176758, 31.10176758, -4.8406461, 0.0],
            ]
        ),
    )
    ...
    np.testing.assert_almost_equal(
        ...
        np.array(
            [
                [0.0, 2.64389392, -0.9, -0.9, -0.9, 0.0],
                [0.0, -3.88148228, -2.59451636, 0.97557093, -2.03086336, 3.14],
                [0.0, 31.10176758, -31.10176758, 21.42157911, -10.39178501, 0.0],
                [0.0, -31.10176758, 31.10176758, 31.10176758, -23.44580925, 0.0],
            ]
        ),
    )
    ...
    np.testing.assert_almost_equal(
        ...
        np.array(
            [
                [0.0, 2.64389392, -0.9, -0.9, -0.9, -0.9, -0.9, -0.9, -0.9, 0.46580081, 0.0],
                [
                    0.0,
                    -6.18318531,
                    6.18318531,
