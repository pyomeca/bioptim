...
def test_multistart():
    ...
    np.testing.assert_almost_equal(
        multi_start_0,
        np.array([[  0.        ,   2.5822724 ,   1.23316051,   0.5385982 ,
         -0.91614241,   0.        ],
       [  0.        ,   6.18318531,   6.18318531,  -2.92943415,
          6.18318531,   3.14      ],
    ...
    np.testing.assert_almost_equal(
        multi_start_2,
        np.array([[  0.        ,   2.5822724 ,   1.23316051,   0.5385982 ,
         -0.91614241,   1.75072936,  -0.74895346,   4.70127601,
          4.9       ,  -0.9       ,   0.        ],
       [  0.        ,   1.71014635,   6.18318531,  -6.18318531,
         -6.18318531,  -6.18318531,   6.18318531,   6.18318531,
          6.18318531,   6.18318531,   3.14      ],
       [  0.        ,  31.10176758, -31.10176758,  17.58299411,
        -31.10176758,  31.10176758,   2.74554108, -10.7238969 ,
        -29.58681437,  31.10176758,   0.        ],
       [  0.        , -31.10176758,  14.78251254,  14.08636396,
         14.69435942,  31.10176758,  22.84821264, -17.6547579 ,
         -7.91279805,  24.83506853,   0.        ]])
