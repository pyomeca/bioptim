...
def test_multistart():
    ...
    np.testing.assert_almost_equal(
        ...
        np.array(
            [
                [0.0, -0.9, -0.9, 2.28173011, -0.9, 0.0],
                [0.0, -3.33470877, 1.03582785, 0.5207875, 6.18318531, 3.14],
                [0.0, 31.10176758, 17.61481121, -31.10176758, 30.90317007, 0.0],
                [0.0, 31.10176758, -31.10176758, 17.78161852, -31.10176758, 0.0],
            ]
        ),
    )
