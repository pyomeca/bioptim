            ...
            if ContactType.RIGID_EXPLICIT in contact_types:
                if with_external_force:
                    if defects_type == DefectType.QDDOT_EQUALS_FORWARD_DYNAMICS:
                        npt.assert_almost_equal(
                            ...
                            np.array(
                                [
                                    -0.19733986, -0.19286707, 0.47442614, -0.21751276, 2.36303867,
                                    0.84504995, -4.50760903, 3.92232611
                                ]
                            ),
                        )
                else:
                    if defects_type == DefectType.QDDOT_EQUALS_FORWARD_DYNAMICS:
                        npt.assert_almost_equal(
                            ...
                            np.array(
                                [
                                    -0.48981466, -0.12265368, 0.36203978, 0.11347689, 0.27198618,
                                    0.7248882, 0.99807742, 0.08842979
                                ]
                            ),
                        )
                ...
                if defects_type == DefectType.QDDOT_EQUALS_FORWARD_DYNAMICS:
                    npt.assert_almost_equal(
                        ...
                        np.array(
                            [
                                -0.48981466, -0.12265368, 0.36203978, 0.11347689,
                                -0.20592043, 10.66048726, 2.36458005, -19.80096095,
                    ...
                    npt.assert_almost_equal(
                        ...
                        np.array(
                            [
                                -4.89814660e-01, -1.22653677e-01, 3.62039776e-01, 1.13476887e-01,
                                -6.86116772e+00, -1.41889201e+02, -4.93022460e+00, -1.49950526e+00,
                                7.70919162e-01, 7.35159931e-01, 1.10755289e+00
                            ]
                        ),
                        decimal=6,
                    )
                ...
                if with_external_force:
                    if defects_type == DefectType.QDDOT_EQUALS_FORWARD_DYNAMICS:
                        npt.assert_almost_equal(
                            ...
                            np.array(
                                [
                                    -0.19733986, -0.19286707, 0.47442614, -0.21751276,
                                    1.29981099, 10.66675032, -5.20925874, -17.23035513
                                ]
                            ),
                        )
                    else:
                        npt.assert_almost_equal(
                            ...
                            np.array(
                                [
                                    -0.19733986, -0.19286707, 0.47442614, -0.21751276,
                                    -1.0734216, -139.60897337, -5.3638614, -0.9738995
                                ]
                            ),
                            decimal=6,
                        )
                    ...
                    if defects_type == DefectType.QDDOT_EQUALS_FORWARD_DYNAMICS:
                        npt.assert_almost_equal(
                            ...
                            np.array(
                                [
                                    -0.48981466, -0.12265368, 0.36203978, 0.11347689,
                                    -0.21226781, 10.68042395, 2.39425844, -19.95918011
                                ]
                            ),
                        )
                    else:
        ...
        if defects_type == DefectType.QDDOT_EQUALS_FORWARD_DYNAMICS:
            npt.assert_almost_equal(
                ...
                np.array(
                    [
                        -4.89814660e-01, -1.22653677e-01, 3.62039776e-01, 1.13476887e-01,
                        4.13788060e-02, 1.11261314e+01, 1.08042394e+00, -5.18792532e+01,
        ...
        if with_contact:
            if with_external_force:
                npt.assert_almost_equal(
                    ...
                    np.array(
                        [
                            -0.84999038, -0.42807864, -0.3572481, -0.29340385, 2.49283506,
                            1.21776478, -3.65027157, 4.01881518, -0.49085488, 0.08114766,
                            0.59466416, -0.79841555
                        ]
                    ),
                )
            else:
            ...
            if with_external_force:
                if defects_type == DefectType.QDDOT_EQUALS_FORWARD_DYNAMICS:
                    npt.assert_almost_equal(
                        ...
                        np.array(
                            [
                                -0.84999038, -0.42807864, -0.3572481, -0.29340385,
                                1.38011043, 10.99989806, -4.08219355, -13.09464479,
                                -0.49085488, 0.08114766, 0.59466416, -0.79841555
                            ]
                        ),
                    )
                else:
                    npt.assert_almost_equal(
                        ...
                        np.array(
                            [
                                -8.49990382e-01, -4.28078639e-01, -3.57248104e-01, -2.93403854e-01,
                                -5.70258892e+00, -1.45376254e+02, -7.08538520e+00, -1.08402622e+00,
                                -4.90854883e-01, 8.11476605e-02, 5.94664162e-01, -7.98415548e-01
                            ]
                        ),
                        decimal=6,
                    )
    ...
    if ContactType.SOFT_IMPLICIT in contact_types:
        if defects_type == DefectType.QDDOT_EQUALS_FORWARD_DYNAMICS:
            npt.assert_almost_equal(
                ...
                np.array(
                    [
                        -2.23175605e-01, -2.42479878e-01, 1.64699917e-01, -7.93901801e-02,
                        1.22119681e+00, 1.07432483e+01, -1.76659607e+00, -4.21293061e+01,
                        -7.76010969e-01, -1.77815559e-01, -1.27659550e-01, 5.48257658e-01,
                        -9.62447295e-01, -3.68869474e-02, -9.08265886e-01, -2.42055272e-01,
                        -3.67783133e-01, -8.35302496e-01, -6.77564362e-01, -1.74366429e-01,
                        -3.41066351e-01, -6.59984046e-01, -9.31027678e-02, -3.49209575e-01
                    ]
                ),
            )
        else:
    ...
    if ContactType.SOFT_EXPLICIT in contact_types:
        if defects_type == DefectType.QDDOT_EQUALS_FORWARD_DYNAMICS:
            npt.assert_almost_equal(
                ...
                np.array(
                    [
                        -0.22317561, -0.24247988, 0.16469992, -0.07939018,
                        1.16551709, 10.71022124, -1.48485748, -35.30859082,
                        -0.77601097, -0.17781556, -0.12765955, 0.54825766
                    ]
                ),
            )
        else:
                ...
                if defects_type == DefectType.QDDOT_EQUALS_FORWARD_DYNAMICS:
                    npt.assert_almost_equal(
                        ...
                        np.array(
                            [
                                -0.19733986, -0.19286707, 0.47442614, -0.21751276,
                                12.37994595, 2.07360077, -24.69154011, 24.10625719
                            ]
                        ),
                        decimal=5,
                    )
                ...
                if defects_type == DefectType.QDDOT_EQUALS_FORWARD_DYNAMICS:
                    npt.assert_almost_equal(
                        ...
                        np.array(
                            [
                                -0.48981466, -0.12265368, 0.36203978, 0.11347689,
                                -44.21404209, -0.19096356, 89.98898695, -88.90247974
                            ]
                        ),
                        decimal=5,
                    )
            ...
            if with_external_force:
                if defects_type == DefectType.QDDOT_EQUALS_FORWARD_DYNAMICS:
                    npt.assert_almost_equal(
                        ...
                        np.array(
                            [
                                -1.97339858e-01, -1.92867067e-01, 4.74426136e-01, -2.17512761e-01,
                                7.26366684e+01, 3.66332876e+01, -3.44770087e+02, -1.75556283e+03
                            ]
                        ),
                        decimal=5,
                    )
                    ...
                    npt.assert_almost_equal(
                        ...
                        np.array(
                            [
                                -0.19733986, -0.19286707, 0.47442614, -0.21751276,
                                27.61197224, -53.33437494, 74.57271396, 41.30977157
                            ]
                        ),
                        decimal=5,
                    )
                ...
                if defects_type == DefectType.QDDOT_EQUALS_FORWARD_DYNAMICS:
                    npt.assert_almost_equal(
                        ...
                        np.array(
                            [
                                -4.89814660e-01, -1.22653677e-01, 3.62039776e-01, 1.13476887e-01,
                                -6.61209021e+01, 3.40150373e+01, 1.95979764e+02, -2.15316271e+03
                            ]
                        ),
                        decimal=5,
                    )
                    ...
                    npt.assert_almost_equal(
                        ...
                        np.array(
                            [
                                -0.48981466, -0.12265368, 0.36203978, 0.11347689,
                                78.55464226, -109.94534391, 6.89132889, 47.38625878
                            ]
                        ),
                        decimal=5,
                    )
        ...
        if with_passive_torque:
            if with_external_force:
                if defects_type == DefectType.QDDOT_EQUALS_FORWARD_DYNAMICS:
                    npt.assert_almost_equal(
                        x_defects[:, 0],
                        np.array([8.47546393e-01,  2.59351951e-01, -1.22084636e+02, -1.45062357e+03]),
                        decimal=5,
                    )
                else:
                    npt.assert_almost_equal(
            ...
            if with_external_force:
                if defects_type == DefectType.QDDOT_EQUALS_FORWARD_DYNAMICS:
                    npt.assert_almost_equal(
                        x_defects[:, 0],
                        np.array([8.47546393e-01,  2.59351951e-01, -1.17121402e+02, -1.40586142e+03]),
                        decimal=5,
                    )
                else:
                    npt.assert_almost_equal(
        ...
        if with_passive_torque:
            if with_external_force:
                if defects_type == DefectType.QDDOT_EQUALS_FORWARD_DYNAMICS:
                    npt.assert_almost_equal(
                        x_defects[:, 0],
                        np.array([8.47546393e-01,  2.59351951e-01, -1.20860807e+02, -1.43667920e+03]),
                        decimal=5,
                    )
                else:
                    npt.assert_almost_equal(
            ...
            if with_external_force:
                if defects_type == DefectType.QDDOT_EQUALS_FORWARD_DYNAMICS:
                    npt.assert_almost_equal(
                        x_defects[:, 0],
                        np.array([8.47546393e-01,  2.59351951e-01, -1.15897572e+02, -1.39191705e+03]),
                        decimal=5,
                    )
                else:
                    npt.assert_almost_equal(
...
def test_torque_driven_free_floating_base(cx, phase_dynamics, defects_type):
    ...
    if defects_type == DefectType.QDDOT_EQUALS_FORWARD_DYNAMICS:
        npt.assert_almost_equal(
            ...
            np.array(
                [-0.48981466,  -0.12265368,   0.36203978,   0.11347689,
        -0.3436476 ,  10.90983566,   2.93724966, -35.59258422]
            ),
            decimal=5,
        )
    else:
        npt.assert_almost_equal(
            x_defects[:, 0],
            np.array(
                [-0.48981466, -0.12265368,  0.36203978,  0.11347689, -1.99330085,
    ...
    if ContactType.RIGID_IMPLICIT in contact_types and with_external_force:
                    ...
                    if with_excitation:
                        if with_external_force:
                            npt.assert_almost_equal(
                                ...
                                np.array(
                                    [
                                        -0.54292804, -0.47578903, -0.89044505, -0.44641779,
                                        38.99903987, 15.22840121, -40.43158428, -9.8364957,
                                        25.20495604, 15.77789951, 10.07567827, 5.76797109
                                    ]
                                ),
                                decimal=5,
                            )
                            ...
                            npt.assert_almost_equal(
                                ...
                                np.array(
                                    [
                                        2.05272780e-01, -6.91568116e-02, -1.29311921e-02, 4.72584539e+00,
                                        -1.28005642e+02, 4.56345900e+02, 1.01520109e+01, -8.50131737e+00,
                                        1.48550951e+00, -1.62017941e+01, 3.58364164e+01, 2.69526860e+01
                                    ]
                                ),
                                decimal=5,
                            )
                        ...
                        if with_external_force:
                            npt.assert_almost_equal(
                                x_defects[:, 0],
                                np.array(
                                    [-0.27384499,  -0.42688854,  -0.14962947,  -0.36567318,
                                    61.25857721, -44.54620577]
                                ),
                                decimal=5,
                            )
                        else:
                            npt.assert_almost_equal(
                                x_defects[:, 0],
                                np.array([0.42414034,   0.19654445,  -0.66313773,   1.13868998,
                            -4.0691168 , 120.74475469]),
                                decimal=5,
                            )
                else:
                    if with_excitation:
                        if with_external_force:
                            npt.assert_almost_equal(
                                ...
                                np.array(
                                    [
                                        -5.42928038e-01, -4.75789031e-01, -8.90445049e-01, -1.91930588e-02,
                                        3.40150265e+01, 3.11793932e+01, -4.71686403e+01, 1.03034901e+01,
                                        1.71860583e+01, -6.34730917e+00, 9.28691316e+00, 3.76121580e+00
                                    ]
                                ),
                                decimal=5,
                            )
                            ...
                            npt.assert_almost_equal(
                                ...
                                np.array(
                                    [
                                        2.05272780e-01, -6.91568116e-02, -1.29311921e-02, 5.10609172e+00,
                                        -1.32358031e+02, 4.71632733e+02, -1.40441453e+01, 1.68186702e+01,
                                        -4.32113186e+01, 1.29210328e+01, 6.38477420e-01, 4.25280634e+01
                                    ]
                                ),
                                decimal=5,
                            )
                        ...
                        if with_external_force:
                            npt.assert_almost_equal(
                                x_defects[:, 0],
                                np.array([-0.27384499, -0.42688854, -0.14962947,  0.55562059, 15.460567  ,
                                        10.819210193]),
                                decimal=5,
                            )
                        else:
                            npt.assert_almost_equal(
                                ...
                                np.array(
                                    [
                                        4.24140342e-01, 1.96544453e-01, -6.63137727e-01, 2.41386864e+00,
                                        -4.88604389e+01, 2.05011756e+02
                                    ]
                                ),
                                decimal=5,
                            )
                        ...
                        if with_external_force:
                            if defects_type == DefectType.QDDOT_EQUALS_FORWARD_DYNAMICS:
                                ...
                                npt.assert_almost_equal(
                                    ...
                                    np.array(
                                        [
                                            -0.54292804, -0.47578903, -0.89044505, 0.31041669,
                                            -19.22248632, -6.93204239, -40.43158428, -9.8364957,
                                            25.20495604, 15.77789951, 10.07567827, 5.76797109
                                        ]
                                    ),
                                    decimal=5,
                            ...
                            if defects_type == DefectType.QDDOT_EQUALS_FORWARD_DYNAMICS:
                                ...
                                npt.assert_almost_equal(
                                    ...
                                    np.array(
                                        [
                                            2.05272780e-01, -6.91568116e-02, -1.29311921e-02, -1.70266428e+00,
                                            -1.31826147e+01, -1.28447704e+01, 1.01520109e+01, -8.50131737e+00,
                                            1.48550951e+00, -1.62017941e+01, 3.58364164e+01, 2.69526860e+01
                                        ]
                                    ),
                                    decimal=5,
        ...
        61.25857721, -44.54620577]
                                ...
                                npt.assert_almost_equal(
                                    x_defects[:, 0],
                                    np.array(
                                        [-0.27384499,  -0.42688854,  -0.14962947,  -2.14326015,
       -19.93936948,  -6.05447738]
                            ...
                            if defects_type == DefectType.QDDOT_EQUALS_FORWARD_DYNAMICS:
                                npt.assert_almost_equal(
                                    x_defects[:, 0],
                                    np.array(
                                        [0.42414034,   0.19654445,  -0.66313773,   1.13868998,
        -4.0691168 , 120.74475469]
                                    ),
                                    decimal=5,
                                )
                                ...
                                npt.assert_almost_equal(
                                    x_defects[:, 0],
                                    np.array(
                                        [0.42414034,   0.19654445,  -0.66313773,  -1.89342602,
                        ...
                        if with_external_force:
                            if defects_type == DefectType.QDDOT_EQUALS_FORWARD_DYNAMICS:
                                ...
                                npt.assert_almost_equal(
                                    ...
                                    np.array(
                                        [
                                            -0.54292804, -0.47578903, -0.89044505, -0.59784919,
                                            -19.46454159, -7.29982552, -47.16864032, 10.30349009,
                                            17.18605833, -6.34730917, 9.28691316, 3.7612158
                                        ]
                                    ),
                                    decimal=5,
                                )
                            ...
                            if defects_type == DefectType.QDDOT_EQUALS_FORWARD_DYNAMICS:
                                ...
                                npt.assert_almost_equal(
                                    ...
                                    np.array(
                                        [
                                            2.05272780e-01, -6.91568116e-02, -1.29311921e-02, -2.51010444e+00,
                                            -1.36097225e+01, -1.32621814e+01, -1.40441453e+01, 1.68186702e+01,
                                            -4.32113186e+01, 1.29210328e+01, 6.38477420e-01, 4.25280634e+01
                                        ]
                                    ),
                                    decimal=5,
                        ...
                        if with_external_force:
                            if defects_type == DefectType.QDDOT_EQUALS_FORWARD_DYNAMICS:
                                npt.assert_almost_equal(
                                    x_defects[:, 0],
                                    np.array(
                                        [-0.27384499, -0.42688854, -0.14962947,  0.55562059, 15.460567  ,
       10.81921019]
                                    ),
                                    decimal=5,
                                )
                                ...
                                npt.assert_almost_equal(
                                    x_defects[:, 0],
                                    np.array(
                                        [-0.27384499, -0.42688854, -0.14962947, -2.2628544 , -8.36653992,
       -3.06929409]
                                    ),
                                    decimal=5,
                                )
                            ...
                            if defects_type == DefectType.QDDOT_EQUALS_FORWARD_DYNAMICS:
                                ...
                                npt.assert_almost_equal(
                                    x_defects[:, 0],
                                    np.array(
                                        [0.42414034,  0.19654445, -0.66313773, -2.28210331, -9.70670533,
       -7.06713657]
                                    ),
                                    decimal=5,
                                )
