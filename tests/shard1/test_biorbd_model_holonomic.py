...
def test_example_two_pendulums_algebraic():
    ...
    npt.assert_almost_equal(
        ...
        np.array(
            [
                [
                    1.54, 1.53645293, 1.49090493, 1.46110856, 1.41970745,
                    1.22293077, 1.12028136, 1.01244361, 0.71880381, 0.61168231,
                    0.47492593, -0.04877796, -0.29539943, -0.57208567, -1.29065614,
                    -1.54
                ],
                [
                    1.54, 1.53171625, 1.43067973, 1.3649996, 1.29810734,
                    1.10897703, 1.0374163, 0.93992459, 0.52348463, 0.31612114,
                    0.12283504, -0.14736347, -0.15187642, -0.15372295, -0.06603706,
                    0.
                ],
            ]
        ),
    ...
    npt.assert_almost_equal(
        ...
        np.array(
            [
                [
                    0.99952583, 0.99941032, 0.99681038, 0.99399033, 0.98860777,
                    0.94010247, 0.90022299, 0.84812898, 0.6584849, 0.57424555,
                    0.45727258, -0.04875862, -0.29112201, -0.5413868, -0.96101669,
                    -0.99952583
                ],
                [
                    -0.03079146, -0.03433664, -0.07980643, -0.10946795, -0.15051469,
                    -0.34089199, -0.43542918, -0.52978981, -0.75259394, -0.81868312,
                    -0.88932659, -0.99881059, -0.95668593, -0.84077365, -0.27649037,
                    -0.03079146
                ],
            ]
        ),
    ...
    npt.assert_almost_equal(
        ...
        np.array(
            [
                [
                    0., -0.27855252, -1.03630477, -1.31246541,
                    -1.95618328, -3.72426958, -4.37488071, -4.24866308,
                    -4.22798705, -4.33906877, -5.97324789, -9.14477984,
                    -9.83232325, -10.76632382, -9.97701724, -8.46520416
                ],
                [
                    0., -0.62989128, -2.28678176, -2.86981849,
                    -2.66247711, -2.79724415, -3.10324185, -4.42493009,
                    -7.59665489, -8.59683036, -6.62468483, -1.17527383,
                    0.84182637, 0.28582148, 2.24545193, 4.23600587
                ],
            ]
        ),
        decimal=6,
