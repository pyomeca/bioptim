...
def test_phase_transition_uneven_variable_number_by_mapping():
    ...
    np.testing.assert_almost_equal(states[1]["q"][:, 0], np.array([0.0, 0.0, 7.94963906, 1.57079634]))
    ...
    np.testing.assert_almost_equal(states[1]["qdot"][:, 0], np.array([0.0, 0.0, 12.08453281, -13.88520765]))
    np.testing.assert_almost_equal(
...
def test_multi_model_by_constraint():
    ...
    np.testing.assert_almost_equal(states[1]["q"][:, 0], np.array([-3.14159265, 0.0]), decimal=6)
    np.testing.assert_almost_equal(states[1]["q"][:, -1], np.array([3.14267685, 0.0]), decimal=4)
    # initial and final velocities
    ...
    np.testing.assert_almost_equal(states[1]["qdot"][:, 0], np.array([0.92515377, 1.1095279]), decimal=5)
