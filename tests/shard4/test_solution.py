...
def test_time(ode_solver, phase_dynamics):
    ...
    if ode_solver == OdeSolver.RK4:
        np.testing.assert_almost_equal(time.shape, (11, 1))
...
def test_time_multiphase(ode_solver, phase_dynamics, continuous):
    ...
    if continuous:
        if ode_solver == OdeSolver.RK4:
            np.testing.assert_almost_equal(len(time[0]), 4)
            np.testing.assert_almost_equal(len(time[1]), 5)
            np.testing.assert_almost_equal(len(time[2]), 6)
            ...
            np.testing.assert_almost_equal(time[2][3], 0.8)

        else:
            np.testing.assert_almost_equal(len(time[0]), 16)
            np.testing.assert_almost_equal(len(time[1]), 21)
            np.testing.assert_almost_equal(len(time[2]), 26)
            np.testing.assert_almost_equal(time[0][0], 0)
            np.testing.assert_almost_equal(time[0][-1], 0.2)
            np.testing.assert_almost_equal(time[1][0], 0.2)
            np.testing.assert_almost_equal(time[1][-1], 0.5)
        ...
        if ode_solver == OdeSolver.RK4:
            ...
            np.testing.assert_almost_equal(time[2][2], 0.2)
    ...
    if continuous:
        if merge_phase:
            ...
            if ode_solver == OdeSolver.RK4:
                ...
                np.testing.assert_equal(time.shape, (63, 1))
                np.testing.assert_almost_equal(time[4], 0.06203787705313508)
                np.testing.assert_almost_equal(time[26], 0.35)
                np.testing.assert_almost_equal(time[47], 0.7)
            ...
            if ode_solver == OdeSolver.RK4:
                ...
                np.testing.assert_equal(time[0].shape, (16, 1))
                np.testing.assert_equal(time[1].shape, (21, 1))
                np.testing.assert_equal(time[2].shape, (26, 1))
        ...
        if merge_phase:
            ...
            if ode_solver == OdeSolver.RK4:
                ...
                np.testing.assert_equal(time.shape, (63, 1))
                np.testing.assert_almost_equal(time[4], 0.06203787705313508)
                np.testing.assert_almost_equal(time[26], 0.15)
                np.testing.assert_almost_equal(time[47], 0.2)
...
def test_generate_decision_time(ode_solver, merge_phase, phase_dynamics, continuous):
    ...
    if continuous:
        if merge_phase:
            ...
            np.testing.assert_almost_equal(time[-1], 1)
            if ode_solver == OdeSolver.RK4:
                np.testing.assert_equal(time.shape, (15, 1))
                np.testing.assert_almost_equal(time[2], 0.13333333333)
                np.testing.assert_almost_equal(time[7], 0.425)
                np.testing.assert_almost_equal(time[14], 1.0)
            else:
                np.testing.assert_equal(time.shape, (63, 1))
                np.testing.assert_almost_equal(time[4], 0.06203787705313508)
                np.testing.assert_almost_equal(time[26], 0.35)
            ...
            np.testing.assert_almost_equal(time[-1][-1], 1)
            if ode_solver == OdeSolver.RK4:
                np.testing.assert_equal(time[0].shape, (4, 1))
                np.testing.assert_equal(time[1].shape, (5, 1))
                np.testing.assert_equal(time[2].shape, (6, 1))
                np.testing.assert_almost_equal(time[0][2], 0.13333333333)
                np.testing.assert_almost_equal(time[1][2], 0.35)
                np.testing.assert_almost_equal(time[2][2], 0.7)
            else:
                np.testing.assert_equal(time[0].shape, (16, 1))
                np.testing.assert_equal(time[1].shape, (21, 1))
                np.testing.assert_equal(time[2].shape, (26, 1))
        ...
        if merge_phase:
            ...
            if ode_solver == OdeSolver.RK4:
                np.testing.assert_equal(time.shape, (15, 1))
                np.testing.assert_almost_equal(time[2], 0.13333333333)
                np.testing.assert_almost_equal(time[7], 0.225)
                np.testing.assert_almost_equal(time[14], 0.5)
            else:
                np.testing.assert_equal(time.shape, (63, 1))
                np.testing.assert_almost_equal(time[4], 0.06203787705313508)
                np.testing.assert_almost_equal(time[26], 0.15)
            ...
            if ode_solver == OdeSolver.RK4:
                ...
                np.testing.assert_equal(time[2].shape, (6, 1))
                np.testing.assert_almost_equal(time[0][2], 0.13333333333)
                np.testing.assert_almost_equal(time[1][2], 0.15)
                np.testing.assert_almost_equal(time[2][2], 0.2)
            else:
                np.testing.assert_equal(time[0].shape, (16, 1))
                np.testing.assert_equal(time[1].shape, (21, 1))
