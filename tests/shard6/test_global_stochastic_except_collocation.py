    ...
    if not with_cholesky:
        ...
        if not with_scaling:
            ...
            np.testing.assert_almost_equal(
                ...
                np.array(
                    [
                        1.11119915e+00, -1.44056147e-04, -7.92387508e-03, 1.29653660e-02,
                        4.03350767e-04, 1.11072947e+00, -3.63028044e-02, 3.43506625e-02,
                        -1.22287288e-02, -4.03446951e-04, 1.10058636e+00, 3.63086964e-02,
                        -5.38166455e-05, -1.21464871e-02, 4.84391756e-03, 1.09318297e+00,
                    ]
                ),
            )
            ...
            np.testing.assert_almost_equal(
                ...
                np.array(
                    [
                        -2.44361371e-05, 5.03988822e-05, -2.53889736e-04, 5.54490654e-04,
                        5.03988822e-05, -1.05730935e-04, 4.57675296e-04, -1.03369318e-03,
                        -2.53889736e-04, 4.57675296e-04, -4.38051559e-03, 9.28976812e-03,
                        5.54490654e-04, -1.03369318e-03, 9.28976812e-03, -2.03118675e-02,
                    ]
                ),
            )
            ...
            np.testing.assert_almost_equal(
                ...
                np.array(
                    [
                        1.00000000e+00, 2.83470503e-29, -2.73371469e-01, 5.61967286e-01,
                        -5.54924440e-28, 1.00000000e+00, -1.06373905e+00, 2.76850288e+00,
                        -1.00000000e-01, 2.69216079e-27, 5.97588981e-01, 1.05005559e+00,
                        -1.54142332e-27, -1.00000000e-01, -1.20328930e-02, 9.99955126e-01,
                    ]
                ),
            )
            ...
            np.testing.assert_almost_equal(
                ...
                np.array(
                    [
                        -4.51226127e-30, 8.33773592e-30, -1.35562569e+00, 1.12573123e+00,
                        1.73767029e-29, 1.26613716e-28, 1.12573123e+00, -3.79219059e+00,
                        -2.46703922e-29, -2.77757617e-28, 8.44560218e-02, -2.14525153e-01,
                        -2.12049507e-28, -7.55987586e-28, 7.46209951e-01, -2.20583953e+00,
                        -4.98343155e-25, -4.67005692e-27, 4.43752625e-01, -7.50216036e-01,
                        -1.13596005e-27, 2.87218037e-27, -2.08200045e-01, 5.33395037e-01,
                    ]
                ),
            )
    else:
        ...
        if not with_scaling:
            ...
            np.testing.assert_almost_equal(
                ...
                np.array(
                    [
                        1.11109420e+00, -2.00975244e-05, 1.52182976e-03, 1.80877721e-03,
                        1.76457230e-04, 1.11160762e+00, -1.58811508e-02, -4.46861689e-02,
                        -1.24668133e-02, -6.45898260e-05, 1.12201319e+00, 5.81308511e-03,
                        -7.64514277e-06, -1.24164397e-02, 6.88061131e-04, 1.11747957e+00,
                    ]
                ),
            )
            ...
            np.testing.assert_almost_equal(
                ...
                np.array(
                    [
                        -8.67400623e-03, 5.77329567e-05, -1.30885973e-03, 1.12501586e-02,
                        4.64929473e-03, 2.32462786e-03, 4.92631923e-03, 3.97615552e-03,
                        6.52664876e-03, -6.66843408e-04,
                    ]
                ),
            )
            ...
            np.testing.assert_almost_equal(
                ...
                np.array(
                    [
                        1.00000000e+00, -8.35886644e-14, -2.60671845e-02, -6.51469362e-02,
                        -1.10663430e-14, 1.00000000e+00, -3.68704938e-01, 7.95318548e-01,
                        -1.00000000e-01, -1.65656031e-14, 1.13051096e+00, 7.33175161e-02,
                        -1.61686165e-14, -1.00000000e-01, 6.34380653e-02, 9.83897210e-01,
                    ]
                ),
            )
            ...
            np.testing.assert_almost_equal(
                ...
                np.array(
                    [
                        -1.12917038e-15, 4.53652494e-15, -1.35499971e+00, 1.12950724e+00,
                        1.05525107e-14, -2.09358023e-14, 1.12950724e+00, -3.79903115e+00,
                        -2.39923923e-14, 4.58953582e-14, -2.78756182e-02, 1.26240135e-01,
                        -3.27866630e-14, 7.03268708e-14, -9.99367009e-02, 2.09729743e-01,
                        -3.14543642e-12, 3.70435383e-12, 1.91480322e-02, 8.03625184e-03,
                        -1.12721323e-12, 2.00365744e-12, 1.01115604e-03, 2.88702060e-03,
                    ]
                ),
            )
