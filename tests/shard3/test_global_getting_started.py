...
def test_pendulum(ode_solver, use_sx, n_threads, phase_dynamics):
    ...
    global test_memory
    test_memory[f"pendulum-{ode_solver}-{use_sx}-{n_threads}-{phase_dynamics}"] = [building_duration, solving_duration, mem_used]
...
def test_custom_constraint_track_markers(ode_solver, phase_dynamics):
    ...
    global test_memory
    test_memory[f"custom_constraint_track_markers-{ode_solver}-{phase_dynamics}"] = [building_duration, solving_duration, mem_used]
...
def test_initial_guesses(ode_solver, interpolation, random_init, phase_dynamics):
    ...
    global test_memory
    test_memory[f"initial_guesses-{ode_solver}-{interpolation}-{random_init}-{phase_dynamics}"] = [building_duration, solving_duration, mem_used]
...
def test_parameter_optimization(ode_solver, phase_dynamics):
    ...
    global test_memory
    test_memory[f"parameter_optimization-{ode_solver}-{phase_dynamics}"] = [building_duration, solving_duration, mem_used]
...
def test_custom_problem_type_and_dynamics(problem_type_custom, ode_solver, phase_dynamics):
    ...
    global test_memory
    test_memory[f"custom_dynamics-{ode_solver}-{problem_type_custom}-{phase_dynamics}"] = [building_duration, solving_duration, mem_used]
...
def test_example_external_forces(ode_solver, phase_dynamics, n_threads, use_sx, use_point_of_applications):
    ...
    global test_memory
    test_memory[f"external_forces-{ode_solver}-{use_sx}-{n_threads}-{phase_dynamics}-{use_point_of_applications}"] = [building_duration, solving_duration, mem_used]
...
def test_contact_forces_inequality_greater_than_constraint(ode_solver, phase_dynamics, expand_dynamics):
    ...
    global test_memory
    test_memory[f"contact_forces_greater_than_constraint-{ode_solver}-{phase_dynamics}-{expand_dynamics}"] = [building_duration, solving_duration, mem_used]
...
def test_multinode_constraints(ode_solver, phase_dynamics):
    ...
    global test_memory
    test_memory[f"multinode_constraints-{ode_solver}-{phase_dynamics}"] = [building_duration, solving_duration, mem_used]
...
def test_memory_and_execution_time():
    ...
    ref = {"pendulum-<class 'bioptim.dynamics.ode_solvers.OdeSolver.RK1'>-False-1-PhaseDynamics.SHARED_DURING_THE_PHASE": [9.1513352394104, 3.5536017417907715, 598816], "pendulum-<class 'bioptim.dynamics.ode_solvers.OdeSolver.RK1'>-False-2-PhaseDynamics.SHARED_DURING_THE_PHASE": [9.185523986816406, 3.9750709533691406, 559443], "pendulum-<class 'bioptim.dynamics.ode_solvers.OdeSolver.RK1'>-True-1-PhaseDynamics.SHARED_DURING_THE_PHASE": [5.862371921539307, 1.7231292724609375, 497764], "pendulum-<class 'bioptim.dynamics.ode_solvers.OdeSolver.RK1'>-True-2-PhaseDynamics.SHARED_DURING_THE_PHASE": [5.8641357421875, 1.9456541538238525, 536214], "pendulum-<class 'bioptim.dynamics.ode_solvers.OdeSolver.RK2'>-False-1-PhaseDynamics.SHARED_DURING_THE_PHASE": [9.462843894958496, 3.889923095703125, 486645], "pendulum-<class 'bioptim.dynamics.ode_solvers.OdeSolver.RK2'>-False-2-PhaseDynamics.SHARED_DURING_THE_PHASE": [9.252295017242432, 4.149457931518555, 553802], "pendulum-<class 'bioptim.dynamics.ode_solvers.OdeSolver.RK2'>-True-1-PhaseDynamics.SHARED_DURING_THE_PHASE": [5.931426048278809, 1.9224112033843994, 485197], "pendulum-<class 'bioptim.dynamics.ode_solvers.OdeSolver.RK2'>-True-2-PhaseDynamics.SHARED_DURING_THE_PHASE": [5.94077205657959, 2.180896043777466, 538165], "pendulum-<class 'bioptim.dynamics.ode_solvers.OdeSolver.RK4'>-False-1-PhaseDynamics.SHARED_DURING_THE_PHASE": [9.500595808029175, 4.094981908798218, 456958], "pendulum-<class 'bioptim.dynamics.ode_solvers.OdeSolver.RK4'>-False-1-PhaseDynamics.ONE_PER_NODE": [24.683043956756592, 4.163797855377197, 883682], "pendulum-<class 'bioptim.dynamics.ode_solvers.OdeSolver.RK4'>-False-2-PhaseDynamics.SHARED_DURING_THE_PHASE": [9.399058818817139, 4.211014032363892, 528664], "pendulum-<class 'bioptim.dynamics.ode_solvers.OdeSolver.RK4'>-True-1-PhaseDynamics.SHARED_DURING_THE_PHASE": [5.973743915557861, 2.2713370323181152, 476722], "pendulum-<class 'bioptim.dynamics.ode_solvers.OdeSolver.RK4'>-True-1-PhaseDynamics.ONE_PER_NODE": [13.790527820587158, 2.2725698947906494, 877330], "pendulum-<class 'bioptim.dynamics.ode_solvers.OdeSolver.RK4'>-True-2-PhaseDynamics.SHARED_DURING_THE_PHASE": [6.054003000259399, 2.4681458473205566, 520273], "pendulum-<class 'bioptim.dynamics.ode_solvers.OdeSolver.RK8'>-True-1-PhaseDynamics.SHARED_DURING_THE_PHASE": [6.498960971832275, 3.521271228790283, 517774], "pendulum-<class 'bioptim.dynamics.ode_solvers.OdeSolver.RK8'>-True-2-PhaseDynamics.SHARED_DURING_THE_PHASE": [6.61425518989563, 3.708000659942627, 540117], "pendulum-<class 'bioptim.dynamics.ode_solvers.OdeSolver.IRK'>-False-1-PhaseDynamics.SHARED_DURING_THE_PHASE": [9.551395893096924, 4.164907932281494, 526344], "pendulum-<class 'bioptim.dynamics.ode_solvers.OdeSolver.IRK'>-False-2-PhaseDynamics.SHARED_DURING_THE_PHASE": [9.98697304725647, 4.516143798828125, 572859], "pendulum-<class 'bioptim.dynamics.ode_solvers.OdeSolver.COLLOCATION'>-False-1-PhaseDynamics.SHARED_DURING_THE_PHASE": [9.920191049575806, 4.39845085144043, 506707], "pendulum-<class 'bioptim.dynamics.ode_solvers.OdeSolver.COLLOCATION'>-False-1-PhaseDynamics.ONE_PER_NODE": [22.197954177856445, 4.479645013809204, 1140193], "pendulum-<class 'bioptim.dynamics.ode_solvers.OdeSolver.COLLOCATION'>-False-2-PhaseDynamics.SHARED_DURING_THE_PHASE": [10.074331045150757, 4.760502099990845, 598489], "pendulum-<class 'bioptim.dynamics.ode_solvers.OdeSolver.COLLOCATION'>-True-1-PhaseDynamics.SHARED_DURING_THE_PHASE": [6.3521199226379395, 2.3463258743286133, 559429], "pendulum-<class 'bioptim.dynamics.ode_solvers.OdeSolver.COLLOCATION'>-True-1-PhaseDynamics.ONE_PER_NODE": [12.132819890975952, 2.38869309425354, 1123733], "pendulum-<class 'bioptim.dynamics.ode_solvers.OdeSolver.COLLOCATION'>-True-2-PhaseDynamics.SHARED_DURING_THE_PHASE": [6.332345724105835, 2.570103168487549, 567673], "pendulum-<class 'bioptim.dynamics.ode_solvers.OdeSolver.TRAPEZOIDAL'>-False-1-PhaseDynamics.SHARED_DURING_THE_PHASE": [9.286965131759644, 3.561800956726074, 543829], "pendulum-<class 'bioptim.dynamics.ode_solvers.OdeSolver.TRAPEZOIDAL'>-False-2-PhaseDynamics.SHARED_DURING_THE_PHASE": [9.503605127334595, 4.053746938705444, 581438], "pendulum-<class 'bioptim.dynamics.ode_solvers.OdeSolver.TRAPEZOIDAL'>-True-1-PhaseDynamics.SHARED_DURING_THE_PHASE": [5.966175079345703, 1.6531569957733154, 507530], "pendulum-<class 'bioptim.dynamics.ode_solvers.OdeSolver.TRAPEZOIDAL'>-True-2-PhaseDynamics.SHARED_DURING_THE_PHASE": [5.999427795410156, 1.8715283870697021, 556466], 'custom_constraint_track_markers-RK4 5 steps-PhaseDynamics.SHARED_DURING_THE_PHASE': [9.820377111434937, 3.551621913909912, 581783], 'custom_constraint_track_markers-RK4 5 steps-PhaseDynamics.ONE_PER_NODE': [26.142763137817383, 3.560593843460083, 882478], 'custom_constraint_track_markers-RK8 5 steps-PhaseDynamics.SHARED_DURING_THE_PHASE': [10.959012985229492, 3.8739609718322754, 542643], 'custom_constraint_track_markers-RK8 5 steps-PhaseDynamics.ONE_PER_NODE': [62.250470876693726, 3.8979461193084717, 890960], 'custom_constraint_track_markers-IRK legendre 4-PhaseDynamics.SHARED_DURING_THE_PHASE': [10.014273881912231, 3.500044107437134, 547007], 'custom_constraint_track_markers-IRK legendre 4-PhaseDynamics.ONE_PER_NODE': [27.963459014892578, 3.5615458488464355, 1125462], 'initial_guesses-COLLOCATION legendre 4-InterpolationType.CONSTANT-True-PhaseDynamics.SHARED_DURING_THE_PHASE': [2.528355121612549, 0.8745269775390625, 316498], 'initial_guesses-COLLOCATION legendre 4-InterpolationType.CONSTANT-True-PhaseDynamics.ONE_PER_NODE': [5.227646112442017, 0.8703899383544922, 441850], 'initial_guesses-COLLOCATION legendre 4-InterpolationType.CONSTANT-False-PhaseDynamics.SHARED_DURING_THE_PHASE': [2.5004818439483643, 0.8465471267700195, 311482], 'initial_guesses-COLLOCATION legendre 4-InterpolationType.CONSTANT-False-PhaseDynamics.ONE_PER_NODE': [5.195713043212891, 0.8620669841766357, 439971], 'initial_guesses-COLLOCATION legendre 4-InterpolationType.CONSTANT_WITH_FIRST_AND_LAST_DIFFERENT-True-PhaseDynamics.SHARED_DURING_THE_PHASE': [2.5244569778442383, 0.867851972579956, 294191], 'initial_guesses-COLLOCATION legendre 4-InterpolationType.CONSTANT_WITH_FIRST_AND_LAST_DIFFERENT-True-PhaseDynamics.ONE_PER_NODE': [5.169760704040527, 0.8655142784118652, 446137], 'initial_guesses-COLLOCATION legendre 4-InterpolationType.CONSTANT_WITH_FIRST_AND_LAST_DIFFERENT-False-PhaseDynamics.SHARED_DURING_THE_PHASE': [2.500936269760132, 0.8467919826507568, 306315], 'initial_guesses-COLLOCATION legendre 4-InterpolationType.CONSTANT_WITH_FIRST_AND_LAST_DIFFERENT-False-PhaseDynamics.ONE_PER_NODE': [5.213915824890137, 0.878535270690918, 445024], 'initial_guesses-COLLOCATION legendre 4-InterpolationType.LINEAR-True-PhaseDynamics.SHARED_DURING_THE_PHASE': [2.6062657833099365, 0.888721227645874, 313048], 'initial_guesses-COLLOCATION legendre 4-InterpolationType.LINEAR-True-PhaseDynamics.ONE_PER_NODE': [5.187885046005249, 0.8783941268920898, 446858], 'initial_guesses-COLLOCATION legendre 4-InterpolationType.LINEAR-False-PhaseDynamics.SHARED_DURING_THE_PHASE': [2.5217301845550537, 0.8631987571716309, 315358], 'initial_guesses-COLLOCATION legendre 4-InterpolationType.LINEAR-False-PhaseDynamics.ONE_PER_NODE': [5.1612937450408936, 0.8431801795959473, 444895], 'initial_guesses-COLLOCATION legendre 4-InterpolationType.EACH_FRAME-True-PhaseDynamics.SHARED_DURING_THE_PHASE': [2.4971258640289307, 0.8691582679748535, 310477], 'initial_guesses-COLLOCATION legendre 4-InterpolationType.EACH_FRAME-True-PhaseDynamics.ONE_PER_NODE': [5.190582990646362, 0.8718810081481934, 443745], 'initial_guesses-COLLOCATION legendre 4-InterpolationType.EACH_FRAME-False-PhaseDynamics.SHARED_DURING_THE_PHASE': [2.5074141025543213, 0.8524069786071777, 309865], 'initial_guesses-COLLOCATION legendre 4-InterpolationType.EACH_FRAME-False-PhaseDynamics.ONE_PER_NODE': [5.156826734542847, 0.8647990226745605, 445298], 'initial_guesses-COLLOCATION legendre 4-InterpolationType.ALL_POINTS-True-PhaseDynamics.SHARED_DURING_THE_PHASE': [2.5335800647735596, 1.0024340152740479, 311591], 'initial_guesses-COLLOCATION legendre 4-InterpolationType.ALL_POINTS-True-PhaseDynamics.ONE_PER_NODE': [5.205708742141724, 1.0020380020141602, 447697], 'initial_guesses-COLLOCATION legendre 4-InterpolationType.ALL_POINTS-False-PhaseDynamics.SHARED_DURING_THE_PHASE': [2.5077292919158936, 0.9837539196014404, 315213], 'initial_guesses-COLLOCATION legendre 4-InterpolationType.ALL_POINTS-False-PhaseDynamics.ONE_PER_NODE': [5.319723844528198, 1.0774710178375244, 445434], 'initial_guesses-COLLOCATION legendre 4-InterpolationType.SPLINE-True-PhaseDynamics.SHARED_DURING_THE_PHASE': [2.5698020458221436, 0.8854770660400391, 306577], 'initial_guesses-COLLOCATION legendre 4-InterpolationType.SPLINE-True-PhaseDynamics.ONE_PER_NODE': [5.157807111740112, 0.8733980655670166, 448234], 'initial_guesses-COLLOCATION legendre 4-InterpolationType.SPLINE-False-PhaseDynamics.SHARED_DURING_THE_PHASE': [2.5160067081451416, 0.9336130619049072, 309463], 'initial_guesses-COLLOCATION legendre 4-InterpolationType.SPLINE-False-PhaseDynamics.ONE_PER_NODE': [5.193099021911621, 0.909325122833252, 447463], 'initial_guesses-COLLOCATION legendre 4-InterpolationType.CUSTOM-True-PhaseDynamics.SHARED_DURING_THE_PHASE': [2.368273973464966, 0.8829538822174072, 314000], 'initial_guesses-COLLOCATION legendre 4-InterpolationType.CUSTOM-True-PhaseDynamics.ONE_PER_NODE': [4.501805067062378, 0.8706808090209961, 443079], 'initial_guesses-COLLOCATION legendre 4-InterpolationType.CUSTOM-False-PhaseDynamics.SHARED_DURING_THE_PHASE': [2.351344108581543, 0.8531820774078369, 312841], 'initial_guesses-COLLOCATION legendre 4-InterpolationType.CUSTOM-False-PhaseDynamics.ONE_PER_NODE': [4.756149053573608, 0.882012128829956, 441641], 'cyclic_objective-RK4 5 steps-PhaseDynamics.SHARED_DURING_THE_PHASE': [4.184632062911987, 1.5201780796051025, 405713], 'cyclic_objective-RK4 5 steps-PhaseDynamics.ONE_PER_NODE': [9.308022737503052, 1.5241172313690186, 510014], 'cyclic_objective-RK8 5 steps-PhaseDynamics.SHARED_DURING_THE_PHASE': [5.524325132369995, 1.6116359233856201, 402263], 'cyclic_objective-RK8 5 steps-PhaseDynamics.ONE_PER_NODE': [20.720319986343384, 1.6008939743041992, 512195], 'cyclic_objective-IRK legendre 4-PhaseDynamics.SHARED_DURING_THE_PHASE': [4.204087018966675, 1.5054340362548828, 355717], 'cyclic_objective-IRK legendre 4-PhaseDynamics.ONE_PER_NODE': [9.792128086090088, 1.5030150413513184, 538596], 'cyclic_constraint-RK4 5 steps-PhaseDynamics.SHARED_DURING_THE_PHASE': [4.1645917892456055, 1.4973511695861816, 400954], 'cyclic_constraint-RK4 5 steps-PhaseDynamics.ONE_PER_NODE': [9.404989957809448, 1.5142982006072998, 512543], 'cyclic_constraint-RK8 5 steps-PhaseDynamics.SHARED_DURING_THE_PHASE': [5.3193039894104, 1.5833299160003662, 404135], 'cyclic_constraint-RK8 5 steps-PhaseDynamics.ONE_PER_NODE': [20.810055017471313, 1.5870802402496338, 513597], 'cyclic_constraint-IRK legendre 4-PhaseDynamics.SHARED_DURING_THE_PHASE': [4.216747999191284, 1.8143420219421387, 356431], 'cyclic_constraint-IRK legendre 4-PhaseDynamics.ONE_PER_NODE': [10.667237997055054, 1.446087121963501, 540792], "phase_transition-<class 'bioptim.dynamics.ode_solvers.OdeSolver.RK4'>-PhaseDynamics.SHARED_DURING_THE_PHASE": [28.063942193984985, 10.764989852905273, 1285552], "phase_transition-<class 'bioptim.dynamics.ode_solvers.OdeSolver.RK4'>-PhaseDynamics.ONE_PER_NODE": [71.56481981277466, 10.783386945724487, 2212663], "phase_transition-<class 'bioptim.dynamics.ode_solvers.OdeSolver.RK8'>-PhaseDynamics.SHARED_DURING_THE_PHASE": [33.94674825668335, 12.605023860931396, 1282232], "phase_transition-<class 'bioptim.dynamics.ode_solvers.OdeSolver.IRK'>-PhaseDynamics.SHARED_DURING_THE_PHASE": [27.74601697921753, 10.12258791923523, 1319276], "phase_transition-<class 'bioptim.dynamics.ode_solvers.OdeSolver.IRK'>-PhaseDynamics.ONE_PER_NODE": [73.12699604034424, 10.62309718132019, 2840879], 'custom_dynamics-RK4 5 steps-True-PhaseDynamics.SHARED_DURING_THE_PHASE': [9.345491886138916, 3.575360059738159, 579659], 'custom_dynamics-RK4 5 steps-True-PhaseDynamics.ONE_PER_NODE': [23.48348593711853, 3.407442092895508, 812917], 'custom_dynamics-RK4 5 steps-False-PhaseDynamics.SHARED_DURING_THE_PHASE': [9.43447208404541, 3.3900868892669678, 540327], 'custom_dynamics-RK4 5 steps-False-PhaseDynamics.ONE_PER_NODE': [25.146296739578247, 3.4173080921173096, 883591], 'custom_dynamics-RK8 5 steps-True-PhaseDynamics.SHARED_DURING_THE_PHASE': [10.66609525680542, 3.62235689163208, 590736], 'custom_dynamics-RK8 5 steps-False-PhaseDynamics.SHARED_DURING_THE_PHASE': [10.773294925689697, 3.694208860397339, 562779], 'custom_dynamics-IRK legendre 4-True-PhaseDynamics.SHARED_DURING_THE_PHASE': [9.442317724227905, 3.5097222328186035, 558782], 'custom_dynamics-IRK legendre 4-True-PhaseDynamics.ONE_PER_NODE': [22.204365968704224, 3.4947710037231445, 923398], 'custom_dynamics-IRK legendre 4-False-PhaseDynamics.SHARED_DURING_THE_PHASE': [9.541068077087402, 3.5327117443084717, 548155], 'custom_dynamics-IRK legendre 4-False-PhaseDynamics.ONE_PER_NODE': [26.964985847473145, 3.5070571899414062, 1147125], 'external_forces-RK4 5 steps-True-1-PhaseDynamics.SHARED_DURING_THE_PHASE-True': [6.517794132232666, 2.3037779331207275, 535800], 'external_forces-RK8 5 steps-True-1-PhaseDynamics.SHARED_DURING_THE_PHASE-True': [7.210792779922485, 3.966912031173706, 526336], 'external_forces-RK4 5 steps-True-1-PhaseDynamics.ONE_PER_NODE-True': [15.120752811431885, 2.271672010421753, 914086], 'external_forces-RK8 5 steps-True-1-PhaseDynamics.ONE_PER_NODE-True': [31.632735013961792, 4.178122043609619, 877876], 'external_forces-RK4 5 steps-True-2-PhaseDynamics.SHARED_DURING_THE_PHASE-True': [6.381742000579834, 2.4875428676605225, 615533], 'external_forces-RK8 5 steps-True-2-PhaseDynamics.SHARED_DURING_THE_PHASE-True': [6.973922967910767, 4.05414080619812, 568032], 'external_forces-RK4 5 steps-False-1-PhaseDynamics.SHARED_DURING_THE_PHASE-True': [10.248576879501343, 3.7544772624969482, 578738], 'external_forces-RK8 5 steps-False-1-PhaseDynamics.SHARED_DURING_THE_PHASE-True': [11.717979907989502, 4.608597993850708, 539600], 'external_forces-IRK legendre 4-False-1-PhaseDynamics.SHARED_DURING_THE_PHASE-True': [10.631656885147095, 3.5057692527770996, 533250], 'external_forces-RK4 5 steps-False-1-PhaseDynamics.ONE_PER_NODE-True': [30.453665018081665, 3.8437700271606445, 880297], 'external_forces-RK8 5 steps-False-1-PhaseDynamics.ONE_PER_NODE-True': [70.94570708274841, 4.963971138000488, 878600], 'external_forces-IRK legendre 4-False-1-PhaseDynamics.ONE_PER_NODE-True': [33.11180520057678, 3.9515271186828613, 1139486], 'external_forces-RK4 5 steps-False-2-PhaseDynamics.SHARED_DURING_THE_PHASE-True': [10.23096513748169, 3.809520959854126, 577617], 'external_forces-RK8 5 steps-False-2-PhaseDynamics.SHARED_DURING_THE_PHASE-True': [11.896209955215454, 3.952944755554199, 571259], 'external_forces-IRK legendre 4-False-2-PhaseDynamics.SHARED_DURING_THE_PHASE-True': [10.347720861434937, 3.8076350688934326, 586735], 'external_forces-RK4 5 steps-True-1-PhaseDynamics.SHARED_DURING_THE_PHASE-False': [6.325876951217651, 2.2698328495025635, 569544], 'external_forces-RK8 5 steps-True-1-PhaseDynamics.SHARED_DURING_THE_PHASE-False': [6.936321020126343, 3.838604688644409, 532452], 'external_forces-RK4 5 steps-True-1-PhaseDynamics.ONE_PER_NODE-False': [15.31987476348877, 2.2700250148773193, 903241], 'external_forces-RK8 5 steps-True-1-PhaseDynamics.ONE_PER_NODE-False': [31.632611751556396, 3.9104461669921875, 877081], 'external_forces-RK4 5 steps-True-2-PhaseDynamics.SHARED_DURING_THE_PHASE-False': [6.359724998474121, 2.4342191219329834, 605774], 'external_forces-RK8 5 steps-True-2-PhaseDynamics.SHARED_DURING_THE_PHASE-False': [7.021723985671997, 4.2617199420928955, 565005], 'external_forces-RK4 5 steps-False-1-PhaseDynamics.SHARED_DURING_THE_PHASE-False': [10.2382652759552, 3.723505735397339, 577926], 'external_forces-RK8 5 steps-False-1-PhaseDynamics.SHARED_DURING_THE_PHASE-False': [11.715183019638062, 4.596646070480347, 531119], 'external_forces-IRK legendre 4-False-1-PhaseDynamics.SHARED_DURING_THE_PHASE-False': [10.297888994216919, 3.495901107788086, 551079], 'external_forces-RK4 5 steps-False-1-PhaseDynamics.ONE_PER_NODE-False': [30.71595001220703, 3.7435030937194824, 881598], 'external_forces-RK8 5 steps-False-1-PhaseDynamics.ONE_PER_NODE-False': [70.45185399055481, 4.641111850738525, 877991], 'external_forces-IRK legendre 4-False-1-PhaseDynamics.ONE_PER_NODE-False': [33.052973985672, 3.9504141807556152, 1146288], 'external_forces-RK4 5 steps-False-2-PhaseDynamics.SHARED_DURING_THE_PHASE-False': [10.27266001701355, 3.804931163787842, 573289], 'external_forces-RK8 5 steps-False-2-PhaseDynamics.SHARED_DURING_THE_PHASE-False': [11.604282140731812, 3.9582459926605225, 580018], 'external_forces-IRK legendre 4-False-2-PhaseDynamics.SHARED_DURING_THE_PHASE-False': [10.62734317779541, 3.843648910522461, 588680], 'multiphase-RK4 5 steps-PhaseDynamics.SHARED_DURING_THE_PHASE': [23.17929220199585, 8.365160942077637, 1115335], 'multiphase-RK4 5 steps-PhaseDynamics.ONE_PER_NODE': [67.69533586502075, 8.916538000106812, 1919312], 'multiphase-RK8 5 steps-PhaseDynamics.SHARED_DURING_THE_PHASE': [26.772330045700073, 9.42667007446289, 1129505], 'multiphase-IRK legendre 4-PhaseDynamics.SHARED_DURING_THE_PHASE': [23.982249975204468, 8.310612916946411, 1140644], 'multiphase-IRK legendre 4-PhaseDynamics.ONE_PER_NODE': [62.950451135635376, 8.694111824035645, 2463043], "contact_forces_greater_than_constraint-<class 'bioptim.dynamics.ode_solvers.OdeSolver.RK4'>-PhaseDynamics.SHARED_DURING_THE_PHASE-True": [6.883507966995239, 4.195178031921387, 247754], "contact_forces_greater_than_constraint-<class 'bioptim.dynamics.ode_solvers.OdeSolver.RK4'>-PhaseDynamics.ONE_PER_NODE-True": [11.95946192741394, 4.369907855987549, 501848], "contact_forces_greater_than_constraint-<class 'bioptim.dynamics.ode_solvers.OdeSolver.IRK'>-PhaseDynamics.SHARED_DURING_THE_PHASE-True": [6.821503162384033, 4.1019127368927, 406984], "contact_forces_greater_than_constraint-<class 'bioptim.dynamics.ode_solvers.OdeSolver.IRK'>-PhaseDynamics.SHARED_DURING_THE_PHASE-False": [6.819267272949219, 4.061187982559204, 373534], "contact_forces_greater_than_constraint-<class 'bioptim.dynamics.ode_solvers.OdeSolver.IRK'>-PhaseDynamics.ONE_PER_NODE-True": [12.595759868621826, 5.469526052474976, 562772], "contact_forces_greater_than_constraint-<class 'bioptim.dynamics.ode_solvers.OdeSolver.IRK'>-PhaseDynamics.ONE_PER_NODE-False": [12.781190872192383, 5.58987021446228, 561468], 'multinode_objective-RK4 5 steps-PhaseDynamics.ONE_PER_NODE': [7.24596095085144, 1.3100521564483643, 556603], 'multinode_objective-RK8 5 steps-PhaseDynamics.ONE_PER_NODE': [16.051567792892456, 1.9029803276062012, 539030], 'multinode_constraints-RK4 5 steps-PhaseDynamics.SHARED_DURING_THE_PHASE': [10.927126169204712, 3.9404168128967285, 678951], 'multinode_constraints-RK4 5 steps-PhaseDynamics.ONE_PER_NODE': [23.453507900238037, 3.9539811611175537, 981493], 'multinode_constraints-RK8 5 steps-PhaseDynamics.SHARED_DURING_THE_PHASE': [14.419713020324707, 4.253767967224121, 674833], 'multinode_constraints-IRK legendre 4-PhaseDynamics.SHARED_DURING_THE_PHASE': [10.90890908241272, 3.7429709434509277, 690377], 'multinode_constraints-IRK legendre 4-PhaseDynamics.ONE_PER_NODE': [24.7413969039917, 3.9145472049713135, 1225773], 'multistart': [0.002456188201904297, 16.426876068115234, 380975], 'variable_scaling-PhaseDynamics.SHARED_DURING_THE_PHASE': [5.885438919067383, 2.3393502235412598, 546399], 'variable_scaling-PhaseDynamics.ONE_PER_NODE': [12.253346920013428, 2.323004961013794, 894848]}
