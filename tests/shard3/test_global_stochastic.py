...
def test_arm_reaching_muscle_driven():
    ...
    np.testing.assert_almost_equal(
        ...
        np.array(
            [
                1.70810520e-01, 9.24608816e-03, -2.72650658e-02, 1.05398530e-02,
                8.98374479e-03, 8.86397629e-03, 9.77792061e-03, 8.40556268e-03,
                9.06928287e-03, 8.39077342e-03, 3.56453950e-03, 1.56534006e-01,
                4.74437345e-02, -7.63108417e-02, 8.00827704e-04, -2.73081620e-03,
                -3.57625997e-03, -5.06587091e-04, -1.11586453e-03, -1.48700041e-03,
                1.48227603e-02, 7.90121132e-03, 7.65728294e-02, 7.35733915e-03,
                7.53514379e-03, 7.93071078e-03, 4.94841001e-03, 9.42249163e-03,
                7.25722813e-03, 9.47333066e-03, 8.57938092e-03, 1.14023696e-02,
                1.50545445e-02, 4.32844317e-02, 5.98000313e-03, 8.57055714e-03,
                7.38539951e-03, 7.95998211e-03, 7.09660591e-03, 8.64491341e-03,
                -2.74736661e-02, 8.63061567e-02, -1.97257907e-01, 9.40540321e-01,
                4.23095866e-02, 1.07457907e-02, -4.36284627e-03, -1.41585209e-02,
                -2.52062529e-02, 4.03005838e-03, 2.29699855e-02, -2.95050053e-02,
                1.01220545e-01, -4.23529363e-01, 3.64376975e-02, 1.04603417e-01,
                1.23306909e-02, 1.68244003e-02, 2.18948538e-02, 8.47777890e-03,
                9.34744296e-02, -1.34736043e-02, 8.27850768e-01, -2.41629571e-01,
                1.97804811e-02, 6.45608415e-03, 7.64073642e-02, 2.95987301e-02,
                8.37855333e-03, 2.53974474e-02, -4.05561279e-02, 2.05592350e-02,
                -4.60172967e-01, 1.50980662e-01, 1.55818997e-03, 9.16055220e-03,
                2.58451398e-02, 9.51675252e-02, 8.06247374e-03, -1.64248894e-03,
                1.03747046e-02, 3.18864595e-02, 6.85657953e-02, 2.83683345e-01,
                -1.10621504e-02, 9.55375664e-03, -1.19784814e-04, 4.83155620e-03,
                9.69920902e-02, 1.02776900e-02, -2.69456243e-02, -1.24806854e-02,
                -3.64739879e-01, -2.20090489e-01, 2.49629057e-02, 6.06502722e-03,
                2.79657076e-02, 3.01937740e-03, 1.89391527e-02, 9.74841774e-02,
            ]
        ),
    )
    ...
    np.testing.assert_almost_equal(
        ...
        np.array(
            [
                ...
                9.98805163e-02, 1.32759716e-05, 9.98685679e-01, 1.32759716e-05,
                1.32759716e-05, 1.32759716e-05, 1.32759716e-05, 9.98805163e-02,
                1.32759716e-05, 9.98685679e-01, 1.32759716e-05, 1.32759716e-05,
                1.00000000e-02, 1.32759716e-05, 9.98805163e-02, 1.32759716e-05,
                9.98685679e-01, 1.32759716e-05, 1.32759716e-05, 1.00000000e-02,
                1.32759716e-05, 9.98805163e-02, 1.32759716e-05, 9.98685679e-01,
            ]
        ),
    )
...
def test_arm_reaching_torque_driven_implicit(with_cholesky, with_scaling):
    ...
    if not with_cholesky:
        ...
        if not with_scaling:
            # Check objective function value
            np.testing.assert_almost_equal(f[0, 0], 54.69985224379656)

            # detailed cost values
            np.testing.assert_almost_equal(sol.detailed_cost[0]["cost_value_weighted"], 54.32008339136118)
            np.testing.assert_almost_equal(sol.detailed_cost[1]["cost_value_weighted"], 0.37976885243538916)
            np.testing.assert_almost_equal(
                f[0, 0], sum(sol.detailed_cost[i]["cost_value_weighted"] for i in range(len(sol.detailed_cost)))
            )

            # initial and final position
            np.testing.assert_almost_equal(q[:, 0], np.array([0.34906581, 2.2458677]))
            np.testing.assert_almost_equal(q[:, -1], np.array([0.92561119, 1.29037047]))
            np.testing.assert_almost_equal(qdot[:, 0], np.array([0, 0]))
            np.testing.assert_almost_equal(qdot[:, -1], np.array([0, 0]))

            np.testing.assert_almost_equal(tau[:, 0], np.array([0.41236619, -0.3019402]))
            np.testing.assert_almost_equal(tau[:, -2], np.array([-0.39331919,  0.25051353]))
            ...
            np.testing.assert_almost_equal(
                ...
                np.array(
                    [
                        1.11112755e+00, 2.59583056e-05, -1.58230391e-03, -2.38966622e-03,
                        1.49765134e-04, 1.11130920e+00, -1.36566090e-02, -1.77763801e-02,
                        -1.24383519e-02, -1.12172481e-04, 1.11954774e+00, 1.00935740e-02,
                        -2.64523768e-05, -1.24142567e-02, 2.43275276e-03, 1.11728557e+00,
                    ]
                ),
            )
            ...
            np.testing.assert_almost_equal(
                ...
                np.array(
                    [
                        1.00000000e+00, -8.52697691e-12, 6.55855871e-03, -8.00703258e-02,
                        -8.52767701e-12, 1.00000000e+00, -2.18239828e-01, 4.70460344e-01,
                        -1.00000000e-01, -5.25564645e-11, 1.04992986e+00, 6.75331769e-02,
                        -2.27751861e-11, -1.00000000e-01, 3.49290194e-02, 9.93850189e-01,
                    ]
                ),
            )
            ...
            np.testing.assert_almost_equal(
                ...
                np.array(
                    [
                        -9.55596295e-17, -1.54067811e-16, -1.35545994e+00, 1.12586820e+00,
                        -2.44280819e-15, -2.27063971e-15, 1.12586820e+00, -3.79227614e+00,
                        2.35553605e-15, 2.12315614e-15, -4.07317154e-02, 6.78173223e-02,
                        5.57501840e-15, 5.07550371e-15, -7.50727482e-02, 1.61831876e-01,
                        4.29241800e-12, 4.18835826e-12, 9.54651163e-02, 9.82494768e-02,
                        2.65129632e-12, 2.44681382e-12, -5.45976741e-02, 1.56733807e-01,
                    ]
                ),
            )
        else:
            # Check objective function value
            np.testing.assert_almost_equal(f[0, 0], 824763.9595723676)

            # detailed cost values
            np.testing.assert_almost_equal(sol.detailed_cost[0]["cost_value_weighted"], 824400.0100122461)
            np.testing.assert_almost_equal(sol.detailed_cost[1]["cost_value_weighted"], 363.9495601214693)
            np.testing.assert_almost_equal(
                f[0, 0], sum(sol.detailed_cost[i]["cost_value_weighted"] for i in range(len(sol.detailed_cost)))
            )
            ...
            # initial and final position
            np.testing.assert_almost_equal(q[:, 0], np.array([0.34906585, 2.24586773]))
            np.testing.assert_almost_equal(q[:, -1], np.array([0.92556658, 1.29027342]))
            np.testing.assert_almost_equal(qdot[:, 0], np.array([0, 0]))
            np.testing.assert_almost_equal(qdot[:, -1], np.array([0, 0]))

            np.testing.assert_almost_equal(tau[:, 0], np.array([0.11358679, -0.29990317]))
            np.testing.assert_almost_equal(tau[:, -2], np.array([-0.67664026,  0.43471468]))

            np.testing.assert_almost_equal(
                k[:, 0],
                np.array(
                    [2.71876875,  0.79451587, -1.25817508, -0.02754651, -2.27237225, -0.83710076,  3.15843589,  0.7482128]
                ),
            )
            np.testing.assert_almost_equal(
                ref[:, 0], np.array([2.81566225e-02, 2.83897305e-01, 1.87766353e-05, 1.87766353e-05])
            )
            np.testing.assert_almost_equal(
                m[:, 0],
                np.array(
                    [
                        1.10584760e+00, -6.69878774e-05, -6.09649253e-02, -9.47656929e-03,
                        2.30616425e-04, 1.10588392e+00, -4.87554207e-02, -4.44407412e-02,
                        -1.20429779e-02, 5.85507645e-05, 1.16030655e+00, 1.13214480e-02,
                        2.68705806e-04, -1.19776632e-02, -4.02806808e-02, 1.11577381e+00,
                    ]
                ),
            )
            ...
            np.testing.assert_almost_equal(
                ...
                np.array(
                    [
                        1.93037552e-05, 1.93037560e-05, 1.93037558e-05, 1.93037553e-05,
                        1.93037560e-05, 1.93037569e-05, 1.93037566e-05, 1.93037561e-05,
                        1.93037558e-05, 1.93037566e-05, 1.93037564e-05, 1.93037559e-05,
                        1.93037553e-05, 1.93037561e-05, 1.93037559e-05, 1.93037553e-05,
                    ]
                ),
            )
            ...
            np.testing.assert_almost_equal(
                ...
                np.array(
                    [
                        9.98122336e-01, -1.11757916e-27, 4.76568522e-01, -3.33771645e-02,
                        1.43698897e-28, 9.98122336e-01, 4.54584543e-01, 4.80547408e-01,
                        -9.98122336e-02, -8.34374760e-28, 2.08235782e+00, 2.92006569e-01,
                        4.97438462e-28, -9.98122336e-02, 5.11428970e-01, 1.12881377e+00,
                    ]
                ),
            )
            ...
            np.testing.assert_almost_equal(
                ...
                np.array(
                    [
                        1.94570223e-31, -1.94570189e-31, -1.36678983e+00, 1.02802898e+00,
                        -7.78280620e-31, -2.73025467e-45, 1.02802898e+00, -3.60947462e+00,
                        -7.78280688e-31, 1.55656192e-30, 9.40414140e-01, 4.49782262e-01,
                        9.72851286e-31, -1.94569168e-31, 3.23171290e-01, 3.08131732e-01,
                        3.18783902e-27, 1.59391948e-27, -2.00956023e-01, -3.09040582e-01,
                        -1.11812795e-41, -3.98480026e-28, -8.30388589e-01, -2.10147914e-01,
                    ]
                ),
            )
    else:
        ...
        if not with_scaling:
            ...
            np.testing.assert_almost_equal(
                k[:, 0],
                np.array(
                    [0.00189563, 0.02705867, -0.00714653, 0.06487798, -0.15842199, -0.04930515, 0.04077914, -0.05071117]
                ),
            )
            ...
            np.testing.assert_almost_equal(
                ref[:, 0], np.array([2.81907781e-02,  2.84412562e-01, 0, 0])
            )
            np.testing.assert_almost_equal(
                m[:, 0],
                np.array(
                    [
                        1.11117800e+00, 5.74496303e-06, -6.02227021e-03, -5.18291816e-04,
                        1.90782053e-04, 1.11146918e+00, -1.71716344e-02, -3.22273064e-02,
                        -1.23773410e-02, -8.05336127e-05, 1.11396106e+00, 7.24817755e-03,
                        -7.90350142e-06, -1.24521009e-02, 7.11391914e-04, 1.12068911e+00,
                    ]
                ),
            )
            ...
            np.testing.assert_almost_equal(
                ...
                np.array(
                    [
                        0.00122792, 0.00120341, 0.00121168, 0.00118693, 0.0011951,
                        0.00121136, 0.00117985, 0.00118825, 0.00120402, 0.00122814,
                    ]
                ),
            )
            ...
            np.testing.assert_almost_equal(
                ...
                np.array(
                    [
                        9.99999994e-01, -4.18302471e-10, -4.89315025e-02, -6.22690957e-02,
                        -4.57777265e-10, 9.99999999e-01, -2.50324579e-01, 3.41299838e-01,
                        -1.00000001e-01, 2.41176854e-09, 9.47809755e-01, 3.25135907e-02,
                        7.54210147e-11, -9.99999999e-02, -1.79887711e-02, 1.02668652e+00,
                    ]
                ),
            )
            ...
            np.testing.assert_almost_equal(
                ...
                np.array(
                    [
                        9.22250867e-12, -2.88762428e-11, -1.35469911e+00, 1.13061978e+00,
                        -1.53781787e-11, 3.60437290e-11, 1.13061978e+00, -3.80091459e+00,
                        1.83034425e-11, -3.41762066e-11, -8.27123470e-03, 9.22737389e-02,
                        4.83015893e-11, -1.20282422e-10, -6.57808417e-02, 1.69050819e-01,
                        -7.18803280e-09, 3.56313048e-08, 8.15217455e-02, 4.28542941e-02,
                        3.27255319e-09, -7.56135618e-09, -8.27016953e-03, 2.96993918e-02,
                    ]
                ),
            )
