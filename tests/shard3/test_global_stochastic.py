    ...
    if not with_cholesky:
        ...
        if not with_scaling:
            ...
            np.testing.assert_almost_equal(
                ...
                np.array(
                    [
                        1.11116548e+00, 1.69225040e-04, -1.24136855e-02, -1.87873266e-05,
                        9.91423176e-06, 1.11130071e+00, -1.25732650e-04, -1.24279166e-02,
                        -4.89337105e-03, -1.52302537e-02, 1.11723170e+00, 1.69086085e-03,
                        -8.92280853e-04, -1.70636573e-02, 1.13159385e-02, 1.11851249e+00,
                    ]
                ),
            )
            ...
            np.testing.assert_almost_equal(
                ...
                np.array(
                    [
                        0.00063089, 0.00063069, 0.00063061, 0.00063069, 0.0006304,
                        0.00063061, 0.00063069, 0.0006304, 0.0006304, 0.00063061,
                    ]
                ),
            )
            ...
            np.testing.assert_almost_equal(
                ...
                np.array(
                    [
                        1.00000000e+00, -6.27778945e-15, -1.00000000e-01, 1.50825740e-13,
                        -5.08479505e-16, 1.00000000e+00, -3.92902176e-15, -1.00000000e-01,
                        -4.99318814e-03, -2.18930905e-01, 1.03235506e+00, 2.10676187e-02,
                        -6.38484153e-02, 4.64208085e-01, 8.86276096e-02, 1.02264381e+00,
                    ]
                ),
            )
            ...
            np.testing.assert_almost_equal(
                ...
                np.array(
                    [
                        1.72463475e-14, -1.37108027e-14, 3.66211709e-14, 5.75378145e-14,
                        -4.93833998e-03, 2.38585054e-03, -1.33999478e-14, 1.37568807e-14,
                        -3.09835486e-14, -5.11696566e-14, 2.18091965e-03, 7.23211184e-03,
                        -1.35469931e+00, 1.13061914e+00, -4.56419900e-02, -7.23344625e-02,
                        7.54932194e-03, 1.00320068e-02, 1.13061914e+00, -3.80091353e+00,
                        7.43271242e-02, 1.53479982e-01, 3.77745396e-02, 7.54496136e-02,
                    ]
                ),
            )
        else:
...
def test_arm_reaching_torque_driven_collocations():
    ...
    q, qdot = states["q"], states["qdot"]
    tau = controls["tau"]
    k, ref, m, cov = stochastic_variables["k"], stochastic_variables["ref"], stochastic_variables["m"], stochastic_variables["cov"]
    ...
    np.testing.assert_almost_equal(
        ...
        np.array(
            [
                -2.2311138, -7.88424867, 0.10891849, -2.50891714, -2.03501113,
                -9.14607336, -0.81082578, -3.96627336
            ]
        ),
    )
    np.testing.assert_almost_equal(
        ref[:, 0], np.array([0.0102648 , 0.12900788, 0.03473712, 0.01714053])
    )
    np.testing.assert_almost_equal(
        m[:, 0],
        np.array(
            [
                -0.03780896, 0.01428981, 0.01329116, 0.0136845, -0.13110697,
                0.01511638, 0.01233682, 0.01759883, -0.12401404, 0.00574906,
                0.00545047, 0.00770349, 0.01409505, -0.03905632, 0.01315758,
                0.01010664, 0.0132242, -0.13156635, 0.01041309, 0.0114354,
                0.00522018, -0.12361953, 0.00471038, 0.00646891, 0.01266273,
                0.01516653, -0.03945049, 0.01487932, 0.01021474, 0.01886193,
                -0.13657921, 0.01491626, 0.004885, 0.00727845, -0.12477003,
                0.00625501, 0.002933, 0.0052785, -0.00021098, -0.02575473,
                -0.03393887, -0.03565643, -0.02612223, -0.11649588, -0.00968069,
                -0.01105033, -0.0044019, -0.12087302,
            ]
        ),
    )
    ...
    np.testing.assert_almost_equal(
        ...
        np.array(
            [
                0.01362556, 0.01064286, 0.02551549, -0.03343807, 0.01064286,
                0.00840897, 0.01840482, -0.01834393, 0.02551549, 0.01840482,
                0.0291329, 0.00457209, -0.03343807, -0.01834393, 0.00457209,
                -0.12020213,
            ]
        ),
    )