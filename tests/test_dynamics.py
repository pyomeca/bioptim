            ...
            if with_excitations:
                if with_external_force:
                    np.testing.assert_almost_equal(
                        x_out[:, 0],
                        [
                            0.6158501 ,   0.50313626,   0.64241928,   1.07179622,
       -33.76217857,  36.21815923,  46.87928022,  -1.80189035,
        53.3914525 ,  48.30056919,  63.69373374, -28.15700995,
                    ...
                    np.testing.assert_almost_equal(
                        x_out[:, 0],
                        [
                            1.83404510e-01,  6.11852895e-01,  7.85175961e-01, -9.29662878e+00,
        3.00872062e+02, -9.50354903e+02,  8.60630831e+00,  3.19433638e+00,
        2.97405608e+01, -2.02754226e+01, -2.32467778e+01, -4.19135012e+01,
                ...
                if with_external_force:
                    np.testing.assert_almost_equal(
                        x_out[:, 0],
                        [6.15850098e-01,  5.03136259e-01,  6.42419278e-01, -8.06478367e+00,
        2.42279101e+02, -7.72114103e+02],
                        decimal=6,
                    )
                else:
                    np.testing.assert_almost_equal(
                        x_out[:, 0],
                        [1.83404510e-01,  6.11852895e-01,  7.85175961e-01, -3.80892207e+00,
        1.20476051e+02, -4.33291346e+02],
                        decimal=6,
                    )
            ...
            if with_excitations:
                if with_external_force:
                    np.testing.assert_almost_equal(
                        x_out[:, 0],
                        [
                            0.6158501 ,   0.50313626,   0.64241928,   0.91952705,
       -39.04876174,  45.31837288,  55.65557816,  50.47052688,
         0.36025589,  58.92377491,  29.70094194, -15.13534937,
                        ],
                    )
                else:
                    np.testing.assert_almost_equal(
                        x_out[:, 0],
                        [
                            1.83404510e-01,  6.11852895e-01,  7.85175961e-01, -9.72712350e+00,
        3.10866170e+02, -9.82725656e+02, -7.72228930e+00, -1.13759732e+01,
        9.51906209e+01,  4.45077128e+00, -5.20261014e+00, -2.80864106e+01,
                ...
                if with_external_force:
                    np.testing.assert_almost_equal(
                        x_out[:, 0],
                        [0.6158501 ,   0.50313626,   0.64241928,   0.91952705,
       -39.04876174,  45.31837288],
                    )
                else:
                    np.testing.assert_almost_equal(
                        x_out[:, 0],
                        [1.83404510e-01,  6.11852895e-01,  7.85175961e-01, -9.72712350e+00,
        3.10866170e+02, -9.82725656e+02],
                        decimal=6,
                    )
