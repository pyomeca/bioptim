...
def test_objective_lagrange_minimize_time():
...
def test_objective_lagrange_minimize_state():
    ocp = prepare_test_ocp()
    x = [np.ones((12, 1)) / 10]
...
def test_objective_lagrange_track_state():
    ocp = prepare_test_ocp()
    x = [np.ones((12, 1)) / 10]
...
def test_objective_lagrange_minimize_markers():
    ocp = prepare_test_ocp()
    x = [np.ones((12, 1)) / 10]
...
def test_objective_lagrange_track_markers():
    ocp = prepare_test_ocp()
    x = [np.ones((12, 1)) / 10]
...
def test_objective_lagrange_minimize_markers_displacement():
    ocp = prepare_test_ocp()
    x = [np.ones((12, 1)) / 10]
...
def test_objective_lagrange_minimize_markers_velocity():
    ocp = prepare_test_ocp()
    x = [np.ones((12, 1)) / 10]
...
def test_objective_lagrange_track_markers_velocity():
    ocp = prepare_test_ocp()
    x = [np.ones((12, 1)) / 10]
...
def test_objective_lagrange_align_markers():
    ocp = prepare_test_ocp()
    x = [np.ones((12, 1)) / 10]
...
def test_objective_lagrange_proportional_state():
    ocp = prepare_test_ocp()
    x = [np.ones((12, 1)) / 10]
...
def test_objective_lagrange_proportional_control():
    ocp = prepare_test_ocp()
    x = [np.ones((12, 1)) / 10]
...
def test_objective_lagrange_minimize_torque():
    ocp = prepare_test_ocp()
    x = [np.ones((12, 1)) / 10]
...
def test_objective_lagrange_track_torque():
    ocp = prepare_test_ocp()
    x = [np.ones((12, 1)) / 10]
...
def test_objective_lagrange_minimize_torque_derivative():
    ocp = prepare_test_ocp()
    x = [np.ones((12, 1)) / 10]
...
def test_objective_lagrange_minimize_muscles_control():
    ocp = prepare_test_ocp()
    x = [np.ones((12, 1)) / 10]
...
def test_objective_lagrange_track_muscles_control():
    ocp = prepare_test_ocp()
    x = [np.ones((12, 1)) / 10]
...
def test_objective_lagrange_minimize_all_controls():
    ocp = prepare_test_ocp()
    x = [np.ones((12, 1)) / 10]
...
def test_objective_lagrange_track_all_controls():
    ocp = prepare_test_ocp()
    x = [np.ones((12, 1)) / 10]
...
def test_objective_lagrange_minimize_contact_forces():
    ocp = prepare_test_ocp()
    x = [np.ones((12, 1)) / 10]
...
def test_objective_lagrange_align_segment_with_custom_rt():
    ocp = prepare_test_ocp()
    x = [np.ones((12, 1)) / 10]
...
def test_objective_lagrange_align_marker_with_segment_axis():
    ocp = prepare_test_ocp()
    x = [np.ones((12, 1)) / 10]
