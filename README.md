...
Then, the kinematics associated with these data are generated by integration, using `scipy.integrate.solve_ivp`. 
...
There is no huge difference with the precedent example. The difference between muscle activation and excitation is 
that the latter is the derivative of the former.
