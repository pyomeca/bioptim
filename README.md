...
For the holonomic constraint to be taken into account in the dynamics, you must declare the constraint in your BioMod file as follow:
...
`RTpredecessor` and `RTsuccessor` correspond to the contact point of the 
