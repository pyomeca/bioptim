...
def prepare_ocp(biorbd_model, final_time, nb_shooting, markers_ref, activations_ref, q_ref,
                kin_data_to_track="markers", show_online_optim=False):
    # Problem parameters
