...
def prepare_ocp(biorbd_model_path, number_shooting_points, final_time, ode_solver=OdeSolver.RK):
    ...
    U_bounds = Bounds(
        [torque_activation_min] * biorbd_model.nbGeneralizedTorque(), [torque_activation_max] * biorbd_model.nbGeneralizedTorque(),
    )
    U_init = InitialConditions([torque_activation_init] * biorbd_model.nbGeneralizedTorque())
...
if __name__ == "__main__":
    ocp = prepare_ocp("cubeWithActuators.bioMod", number_shooting_points=30, final_time=2)
