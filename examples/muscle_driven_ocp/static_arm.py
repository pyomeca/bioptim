...
def prepare_ocp(biorbd_model_path, final_time, number_shooting_points, weight, ode_solver=OdeSolver.RK4):
    # --- Options --- #
    # Model path
    ...
    objective_functions.add(ObjectiveFcn.Mayer.SUPERIMPOSE_MARKERS, first_marker_idx=0, second_marker_idx=5, weight=weight)
