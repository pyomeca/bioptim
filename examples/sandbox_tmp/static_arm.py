...
if __name__ == "__main__":
    ocp = prepare_ocp(biorbd_model_path="arm26.bioMod", final_time=2, number_shooting_points=51, use_SX=True)
    ...
    ocp = prepare_ocp(biorbd_model_path="arm26.bioMod", final_time=2, number_shooting_points=51, use_SX=False)
    tic = time()
    sol_ip = ocp.solve(
        solver=Solver.IPOPT,
        show_online_optim=False,
