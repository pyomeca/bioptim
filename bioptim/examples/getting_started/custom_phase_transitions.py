...
def custom_phase_transition(
    ...
    states_pre = transition.states_mapping.to_second.map(nlp_pre.states['unscaled'].cx_end)
    states_post = transition.states_mapping.to_first.map(nlp_post.states['unscaled'].cx)
