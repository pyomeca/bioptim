...
def prepare_ocp_second_pass(
    ...
    # Initial guess
    x_init = np.vstack((solution.states['unscaled'][0]["q"], solution.states['unscaled'][0]["qdot"]))
    ...
    u_init = InitialGuess(solution.controls['unscaled'][0]["tau"][:, :-1], interpolation=InterpolationType.EACH_FRAME)
