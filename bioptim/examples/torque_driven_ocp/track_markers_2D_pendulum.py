...
def main():
    ...
    ocp.add_plot(
        ...
        update_function=lambda t0, phases_dt, node_idx, x, u, p: get_markers_pos(x, 0, markers_fun, n_q),
        linestyle=".-",
    ...
    ocp.add_plot(
        "Markers plot coordinates",
        update_function=lambda t0, phases_dt, node_idx, x, u, p: get_markers_pos(x, 1, markers_fun, n_q),
        linestyle=".-",
        plot_type=PlotType.STEP,
    ...
    ocp.add_plot(
        "Markers plot coordinates",
        update_function=lambda t0, phases_dt, node_idx, x, u, p: markers_ref[:, 0, :],
    ...
    ocp.add_plot(
        "Markers plot coordinates",
        update_function=lambda t0, phases_dt, node_idx, x, u, p: markers_ref[:, 1, :],
        plot_type=PlotType.PLOT,
        color=marker_color[1],
        legend=title_markers,
    )
