...
def prepare_ocp(
    ...
    objective_functions.add(ObjectiveFcn.Lagrange.MINIMIZE_JCS_ROTATION, segment=2, target=np.zeros((3, )), weight=100) # here the target is the Euler angles of the third JCS in the global (sequence 'xyz'
    objective_functions.add(ObjectiveFcn.Lagrange.MINIMIZE_JCS_ROTATION, segment=2, derivative=True, weight=100)
