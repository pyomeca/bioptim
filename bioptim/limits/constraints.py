...
class ConstraintFunction(PenaltyFunctionAbstract):
    ...
    class Functions:
        ...
        def torque_max_from_q_and_qdot(
            ...
            bound = controller.model.tau_max()(controller.q.cx, controller.qdot.cx)
        ...
        def tau_from_muscle_equal_inverse_dynamics(
            ...
            **unused_param: dict
            ...
            tau_id = controller.model.inverse_dynamics()(q, qdot, qddot, controller.parameters.cx)
