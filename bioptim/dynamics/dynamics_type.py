...
class DynamicsFcn(Enum):
    ...
    # TODO MUSCLE_ACTIVATIONS_AND_TORQUE_DERIVATIVE_DRIVEN = (Problem.muscle_activations_and_torque_derivative_driven,)
    # TODO MUSCLE_ACTIVATIONS_AND_TORQUE_DRIVEN_DERIVATIVE_WITH_CONTACT = (Problem.muscle_activations_and_torque_derivative_driven_with_contact,)
