...
class DynamicsFunctions:
    ...
    @staticmethod
    def custom(states: MX.sym, controls: MX.sym, parameters: MX.sym, t: MX.sym,  nlp) -> DynamicsEvaluation:
        """
        Interface to custom dynamic function provided by the user.
        ...
        return nlp.dynamics_type.dynamic_function(states, controls, parameters, t, nlp)
