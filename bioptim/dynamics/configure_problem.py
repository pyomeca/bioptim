...
class DynamicsOptions(OptionGeneric):
    ...
    def __init__(
        ...
        state_continuity_weight: float | int | ConstraintWeight | ObjectiveWeight = ConstraintWeight(),  # Default is a constraint
        ...
        **extra_parameters: Any,
        ...
        if not isinstance(state_continuity_weight, (float, int, ConstraintWeight, ObjectiveWeight)):
            raise RuntimeError("state_continuity_weight must be an int, a float, an ObjectiveWeight, or a ConstraintWeight.")
