...
class DynamicsOptions(OptionGeneric):
    ...
    def __init__(
        ...
        state_continuity_weight: float | int | NotApplicable | Weight = NotApplicable(),  # Default is a constraint
        ...
        **extra_parameters: Any,
        ...
        if not isinstance(state_continuity_weight, (float, int, NotApplicable, Weight)):
            raise RuntimeError("state_continuity_weight must be a float or NotApplicable.")
