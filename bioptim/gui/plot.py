...
class PlotOcp:
    ...
    def _create_ipopt_output_plot(self):
        """
    ...
    def _update_ipopt_output_plot(self, args):
        """
        ...
        if f != 0 and g.shape[0] != 0 and (len(self.ipopt_plots["f"]) == 0 or args["f"] != self.ipopt_plots["f"][-1]):
            ...
            self.ipopt_plots["x"].append(x)
            self.ipopt_plots["f"].append(f)
            self.ipopt_plots["g"].append(g)
            self.ipopt_plots["inf_pr"].append(inf_pr)
            self.ipopt_plots["inf_du"].append(inf_du)

            self.ipopt_plots.plots[0].set_ydata(self.ipopt_plots["x"])
            self.ipopt_plots.plots[1].set_ydata(self.ipopt_plots["f"])
            self.ipopt_plots.plots[2].set_ydata(self.ipopt_plots["g"])
            self.ipopt_plots.plots[3].set_ydata(self.ipopt_plots["inf_pr"])
            self.ipopt_plots.plots[4].set_ydata(self.ipopt_plots["inf_du"])
