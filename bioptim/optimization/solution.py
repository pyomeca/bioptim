...
class Solution:
    ...
    def _generate_time(
        ...
        for p, nlp in enumerate(self.ocp.nlp):
            ...
            add_initial_collocation_point = False
            if is_direct_collocation:
                add_initial_collocation_point = nlp.ode_solver.add_initial_collocation_point
            ...
            step_times = self._define_step_times(
                ...
                add_initial_collocation_point=add_initial_collocation_point,
                keep_intermediate_points=keep_intermediate_points,
    ...
    def _define_step_times(
        ...
        if is_direct_collocation:
            ...
            if keep_intermediate_points:
                if add_initial_collocation_point:
